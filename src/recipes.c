...
add_instruction(&vegetable_curry_roux, "Add <i>3 g (1 tbsp)</i> of <a href='garam_masala.html'>garam masala</a>, <i>3 g (1 tsp)</i> of <a href='curry_powder.html'>curry powder</a> and <i>1.5 g (1/2 tsp)</i> of <a href='cayenne_pepper_powder.html'>powdered cayenne pepper</a>(possible to omit, but we like a bit of kick). Mix well.");
