...
add_instruction(&beet_sauce_pasta_sauce, "Turn off the heat, and mix in <i>15 ml (1 tbsp)</i> of <a href='balsamic_vinegar.html'>balsamic vinegar</a>, <i>5 ml (1 tsp)</i> <a href='lemon_juice.html'>lemon juice</a> and a <i>15 g (~1/4 cup)</i> of <a href='nutritional_yeast.html'>nutritional yeast</a>.");
add_instruction(&beet_sauce_pasta_sauce, "Optionally, purée everything in a blender until smooth, or leave it as is. Serve over pasta shape of choice (we used linguini because we had linguini that day, but we like penne best with this sauce). Serve with some sauerkraut, and top with some chopped <a href='black_lives.html'>black olives</a>(or kalamatas). Finally, season with <i>1.25 g (1/4 tsp)</i> of <a href='salt.html'>salt</a> and some <a href='black_pepper.html'>black pepper</a>.");
add_serving(&beet_sauce_pasta_sauce, &red_beets, "3");
