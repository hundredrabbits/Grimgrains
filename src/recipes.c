...
// add_instruction(&bean_chili_chili, "Soak <i>125 g (3/4 cup)</i> of <a href='chickpeas.html'>dry chickpeas</a> and <i>170 g (1 cup)</i> <a href='black_beans.html'>black beans</a> for <u>4-8 hours</u> (I soak them in separate bowls). Drain.");
...
// add_serving(&bean_chili_chili, &chile_powder, "17 g");
// add_serving(&bean_chili_chili, &cumin_seeds, "6 g");
// add_serving(&bean_chili_chili, &oregano, "3 g, dry");
// add_serving(&bean_chili_chili, &tomato_can, "790 g");
// add_serving(&bean_chili_chili, &cocoa_powder, "2.5 g");
// add_serving(&bean_chili_chili, &beer, "350 ml");
// add_serving(&bean_chili_chili, &water, "940 ml");
