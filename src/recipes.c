...
add_instruction(&buckwheat_dumplings_dumplings, "In a pan, roast <i>150 g (1 cup)</i> (to yield 1 cup flour) of <a href='buckwheat_groats.html'>buckwheat groats</a> (the de-hulled kind) for 3-5 minutes. Roasting groats in a pan lightly dries them out, and makes them easier to grind them afterwards.");
...
add_instruction(&buckwheat_dumplings_sauce, "Pour sauce over buckwheat dumplings, and season with salt black pepper.");
