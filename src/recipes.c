...
add_instruction(&soybean_coffee_roast, "Once cooled off, grind the beans(skins and all) in a grain or coffee grinder. Roasted soybeans are easy to grind. <img src='../media/recipes/soybean_coffee_01.jpg'/>");
add_instruction(&soybean_coffee_roast, "Keep in a cool dry place. Brew the ground coffee as you would a regular cup of coffee. Although in a moka pot we add less than we do when preparing real coffee, because it seems to expand more when brewed and can block the passage of water. <img src='../media/recipes/soybean_coffee_02.jpg'/>");
