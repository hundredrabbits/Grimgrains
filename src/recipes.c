...
add_instruction(&cookie_mix, "Measure <i>55 g (1/2 cup)</i> of <a href='vegan_butter.html'>vegan butter</a>. It should be slightly cooler than room temp.");
...
add_instruction(&cookie_mix, "Mix <i>125 g (1 cup)</i> of <a href='all_purpose_flour'>all purpose flour</a> with <i>2.5 g (1/4 tsp)</i> of <a href='baking_soda'>baking soda</a> and <i>1.25 g (1/4 tsp)</i> of <a href='salt.html'>salt</a>.");
...
add_serving(&cookie_mix, &vegan_butter, "55 g");
