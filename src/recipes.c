...
set_description(&anise_bread_with_sweet_pear_sauce, "<p>I love baking with the mini silicone pans I bought, I've been making mini everything. This time, I made some anise bread topped with a sweet sauce, and loaded with caramelized pear chunks.</p><p>My bag of anise seeds has been sitting in my pantry, for way too long, begging for purpose. The taste of anise pairs very well with pears.</p>");
...
add_serving(&arame_soba_main, &whole_cane_sugar, "5 g");
...
set_description(&black_sesame_rice_pancakes, "<p>Black sesame rice pancakes, for those who share my love of sesame.</p><p>Photo is with a generous dollop of <a href='mango.html'>mango</a>, because sometimes I need a break from maple syrup — okay. No I don't, but here's something different anyway. The real reason I added mango, was because I enjoyed the contrast of colors. Most times, I top my pancakes with <a href='maple_syrup.html'>maple syrup</a>.</p><p><b>Substitutions:</b> For matcha pancakes, omit the black sesame seeds and add 15 ml of matcha powder.</p>");
...
add_instruction(&black_sesame_syrup_syrup, "Return liquid to pot, add <i>100 g(1/2 cup)</i> of <a href='whole_cane_sugar.html'>sugar</a> and bring to medium heat. Stir to dissolve the sugar. Remove from heat and let cool.");
...
set_description(&cheese, "<p>I used to have a cheese recipe on this website, but it failed me a few times after making it, which made it a poor recipe indeed. This time, I've experiemented a lot more, removing and adding ingredients.</p><p>This is a basic cheese recipe, that you can add onto if you want different flavors. It's simple to prepare, and ready under an hour. Another great thing about it is that it's completely nut-free!</p><p>This cheese can be grated, it holds its shape well enough so it can be used as a topping on pizza — yay!</p><p>In this recipe I use <a href='kanten.html'>kanten</a>, which is similar to <a href='agar_agar.html'>agar agar</a> except that it's made from a different type of red algae (tengusa). It can be swapped 1:1 in a recipe, although the resulting texture will not be the same. Adding agar agar will make the cheese softer, so I highly recommend using kanten if available.</p><p>In this recipe, you can omit the sunflower seeds and 240 ml of water, and replace it with 240 ml of soy milk instead. This will result in a lighter cheese.</p>");
...
set_description(&coffee_jelly, "<p>Coffee jelly is a popular dessert and drink (you could say) that is served in coffee shops in Japan. It is very simple to make, it doesn't require refrigeration to become jelly and it is delicious!</p><p>The key ingredient in this recipe is kanten, or agar agar, a gelling agent that is algae based and that is widely available in asia. It is available in powder form, and also in sheets. Sheets can be melted in a liquid the same way as the powder form. Agar agar has no calories, and imparts no flavour.</p><p>You can use instant coffee as well for this recipe, using 30 ml of instant coffee per cup.</p><p>On Pino, we sometimes make the mix without a sweetener, and pour a spoonful on top afterwards.</p><p><b>Quick soy pudding</b></p><p>You can eat the coffee jelly as is, or you can add the cubes in another recipe like a coconut or soy milk pudding. It can also be used as a garnish for other desserts.</p><p>Also, I sometimes make a quick 'soy pudding' by heating some soy milk in a pan with some arrowroot starch. The mixture will thicken, it becomes pudding-like and is delicious over coffee jelly.</p>");
...
set_description(&vege_pate, "<p>Végé pâté is Quebec staple food. It's great with veggies, on crackers and in sandwiches. Purchasing it pre-made can be expensive, and not all brands are good. </p><p><b>Substitutions</b></p><p>A lot of végé pâté recipes call for whole wheat flour, I've made pâté with it before with great results. If you don't have oats, you can use whole wheat flour instead.</p>");
