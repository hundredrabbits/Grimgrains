...
add_instruction(&millet_dumplings_assembly, "Remove cover, add <i>5 ml (1 tsp)</i> of <a href='roasted_sesame_oil.html'>roasted sesame oil</a> and cook for <u>2-3</u> minutes to crisp the bottoms up further. Transfer the cooked dumplings to a plate.");
...
// add_instruction(&vegetable_curry_rice,"Rinse <i>145 g (3/4 cup)</i> of <a href='basmati_rice.html'>white basmati rice</a> for a few minutes to get rid of the starch that makes the rice sticky. Basmati rice requires a water to rice ratio of 2:1");
// add_instruction(&vegetable_curry_rice,"Add the rice to a pot along with a bit of salt.");
// add_instruction(&vegetable_curry_rice,"Pour <i>375 ml (1 1/2 cups)</i> of boiling water over the rice, then heat the pot(and its contents) at <u>medium-high heat</u>. When the water begins to boil, cover the pot with a lid, then reduce the heat heat to low. Cook for <u>15 min</u>. Remove from heat and let rest for another <u>5 min</u> with the lid still on. Divide cooked rice into two bowls.");
...
// add_instruction(&vegetable_curry_roux, "Heat a pan to medium heat. When the pan is hot, add <i>13 g</i> of <a href='vegan_butter.html'>vegan butter</a>(or neutral oil, like sesame, or canola).");
// add_instruction(&vegetable_curry_roux, "When butter is melted (or oil is hot) add <i>13 g</i> of <a href='all_purpose_flour.html'>all purpose flour</a>. Stir the flour into the butter continuously with a whisk(to better take apart clumps of flour). Reduce the heat to low and continue to stir for <u>10-15 minutes</u> to cook the flour. As the mixture heats up, the flour will mix with the fat, swell, before becoming more runny.");
// add_instruction(&vegetable_curry_roux, "Add <i>9 g (1 tbsp)</i> of <a href='garam_masala.html'>garam masala</a>, <i>3 g (1 tsp)</i> of <a href='curry_powder.html'>curry powder</a> and <i>1.5 g (1/2 tsp)</i> of <a href='cayenne_pepper_powder.html'>powdered cayenne pepper</a>(possible to omit, but we like a bit of kick). Mix well.");
// add_instruction(&vegetable_curry_roux, "Stir in <i>375 ml (1 1/2 cups)</i> of <a href='water.html'>water</a>(or <a href='vegetable_bouillon.html'>vegetable bouillon</a>). Add <i>1 small grated</i> <a href='apple.html'>apple</a>, <i>2.5 g (1/2 tsp)</i> of <a href='dijon_mustard.html'>dijon mustard</a>(see <a href='mustard_from_seed.html'>mustard from seeds recipe</a>) and <i>14 g (1 tbsp)</i> of <a href='tomato_paste.html'>tomato paste</a>. Add the cooked carrots and potato mix and simmer for an additional <u>10 minutes</u>.");
// add_instruction(&vegetable_curry_roux, "Season with salt and black pepper, serve over rice with some fermented vegetables overtop (see <a href='lactofermentation.html'>lactofermentation</a>. We like to add sauerkraut, or mild kimchi(we don't use gochugaru in ours, just chili pepper flakes).");
// add_serving(&vegetable_curry_roux, &vegan_butter, "30 g");
// add_serving(&vegetable_curry_roux, &all_purpose_flour, "20 g");
// add_serving(&vegetable_curry_roux, &garam_masala, "9 g");
// add_serving(&vegetable_curry_roux, &curry_powder, "3 g");
// add_serving(&vegetable_curry_roux, &cayenne_pepper_powder, "1.5 g");
// add_serving(&vegetable_curry_roux, &sesame_oil, "15 ml");
// add_serving(&vegetable_curry_roux, &yellow_onion, "1, small");
// add_serving(&vegetable_curry_roux, &apple, "1 small, grated");
// add_serving(&vegetable_curry_roux, &carrots, "1, large");
// add_serving(&vegetable_curry_roux, &potatoes, "2, small");
...
add_instruction(&black_sesame_rice_pancakes_pancakes, "Mix the soured soy milk with <i>5 ml (1 tsp)</i> of <a href='vanilla_extract.html'>vanilla extract</a> and the ground <a href='black_sesame_seeds.html'>black sesame seeds</a>. Blend until you get a smooth grey liquid.");
...
add_instruction(&black_sesame_syrup_syrup, "Strain liquid from sesame seeds using a cheese cloth or a mesh strainer, squeezing out as much liquid as you can. Reserve sesame seeds for later use.");
...
add_instruction(&carrot_kinpira_onigirazu_rice, "Add <i>350 ml (1 1/2 cups)</i> of <a href='water.html'>water</a> into a pot, and add the rice. Bring pot contents to a boil, turn heat to low and cover pot with lid. Cook for <u>10 minutes</u>, turn heat off and let rest for <u>10 min</u> before uncovering.");
...
add_instruction(&quick_cheese_cheese, "Flip bowls upside down, scoop out cheese and enjoy! This cheese can be grated onto pizza too!");
...
add_instruction(&chunky_apple_jam_jam, "It's possible to refrigerate and eat the jam right away, but if you want the jar to last longer it is necessary to process the jars in a boiling water canner. To do this, bring a large pot of water to a boil, add the jam jars with enough water to cover them, and those living at 0 - 305 m (0 - 1,000 ft) ought to boil the jars for <u>10 minutes</u> (see above notes for altitude adjustments). Turn heat off, but leave jars in pot for an extra <u>5 minutes</u>. Transfer jars to counter-top over a dishtowel, let cool. Once cooled, they're ready to store. Ideally, eat within 12 months.");
...
/*// persimmon curry
Recipe persimmon_curry = create_recipe("persimmon curry", maindish, "2 servings", 20150103, 30);
...
add_instruction(&seitan_seitan, "<i>Separate dough in two</i> - optional, but it creates more surface area that can inbibe flavor. Also, the seitan expands quite a bit and having smaller pieces makes it more manageable.");
