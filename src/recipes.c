...
add_instruction(&brownies_brownies, "Pour into a greased 8X8 baking dish. Optionally, to improve the flavor of the brownies, place the unbaked batter in the refrigerator(or a cool place) <u>overnight (or a few hours)</u> before baking.");
add_instruction(&brownies_brownies, "Bake for <u>~20-25 minutes</u>. Rotate the baking dish halfway through. Cook longer if using vegan butter. To check if it's ready, insert a toothpick into the center, if it comes out with a few moist crumbs attached to it, it's ready. Remove from the oven and let cool. <i>Cut in 24 small squares</i>.");
...
// cornmeal dumplings
Recipe cornmeal_dumplings = create_recipe("cornmeal dumplings", sidedish, "2 people", 20171408, 40);
set_description(&cornmeal_dumplings, "<p>This recipe is typically done using masa, but it is not easy for us to source and so we use cornmeal. The main difference when preparing it is that with cornmeal you need to add boiling water so you can roll the mixture into balls. If you were to use masa, you wouldn't need the added moisture.</p><p>The texture of the dumplings is fun and chewy. The outside is soft, but the inside is like that of dense cornbread.</p><p><b class='head'>Recommendations:</b></p><p>We enjoy eating it with tomato sauce or with a spicy apricot sauce. Instead of apricot jam, you can add apricot juice to the mix (orange will taste wonderful too). We added jam because I didn't have any juice on the boat, and besides, it works well in this recipe.</p><p>Adding extra spices, like cumin, chili flakes and turmeric will add a nice flavor to the dumpling mix.</p>");
RecipePart cornmeal_dumplings_dumplings = create_part("dumplings");
add_instruction(&cornmeal_dumplings_dumplings, "Mix <i>160g (1 cup)</i> <a href='cornmeal.html'>corn meal</a>, <i>30 g (1/4 cup)</i> <a href='all_purpose_flour.html'>all purpose flour</a>, <i>2.5 g (1/2 tsp)</i> <a href='baking_soda.html'>baking soda</a>, <i>5 g (1 tsp)</i> <a href='baking_powder.html'>baking powder</a>, and <i>1.25 g (1/4 tsp)</i> of <a href='salt.html'>salt</a>. Stir until well mixed.");
add_instruction(&cornmeal_dumplings_dumplings, "Bring <i>240 ml (1 cup)</i> of <a href='water.html'>water</a> to a boil, pour into dry ingredients and mix well. When the dough is wet and sticky, form <b>roughly 13mm balls</b> with your hands. You can make larger or smaller balls - note that cooking time will change if the diameter is bigger.");
add_instruction(&cornmeal_dumplings_dumplings, "Bring a big pot of water to a boil, add corn balls and boil for <u>10-15 minutes</u>.");
add_instruction(&cornmeal_dumplings_dumplings, "Drain, let cool.");
add_serving(&cornmeal_dumplings_dumplings, &cornmeal, "160 g");
add_serving(&cornmeal_dumplings_dumplings, &all_purpose_flour, "30 g");
add_serving(&cornmeal_dumplings_dumplings, &baking_soda, "2.5 g");
add_serving(&cornmeal_dumplings_dumplings, &baking_powder, "5 g");
add_serving(&cornmeal_dumplings_dumplings, &salt, "1.25 g");
add_serving(&cornmeal_dumplings_dumplings, &water, "250 ml, boiled");
add_part(&cornmeal_dumplings, &cornmeal_dumplings_dumplings);
RecipePart cornmeal_dumplings_sauce = create_part("sauce");
add_instruction(&cornmeal_dumplings_sauce, "Mix all sauce ingredients together (all, except the arrowroot starch).");
add_instruction(&cornmeal_dumplings_sauce, "Put <i>5 g (1 tsp)</i> of <a href='arrowroot_starch.html'>arrowroot starch</a> in a bowl, and dissolve in <i>60 ml (1/4 cup)</i> of <a href='water.html'>water</a>. Set aside.");
add_instruction(&cornmeal_dumplings_sauce, "Pour sauce into a pan, and bring to medium heat. Once the sauce starts to boil, add a few spoonfuls of the arrowroot starch mix to thicken the sauce. Once thickened, divide cornmeal dumplings into bowls and pour sauce overtop.");
add_serving(&cornmeal_dumplings_sauce, &apricot_jam, "15 g");
add_serving(&cornmeal_dumplings_sauce, &soy_sauce, "30 ml");
add_serving(&cornmeal_dumplings_sauce, &japanese_rice_vinegar, "30 ml");
add_serving(&cornmeal_dumplings_sauce, &lemon_juice, "15 ml");
add_serving(&cornmeal_dumplings_sauce, &sesame_oil, "5 ml");
add_serving(&cornmeal_dumplings_sauce, &water, "60 ml");
add_serving(&cornmeal_dumplings_sauce, &chili_pepper_flakes, "15 g");
add_serving(&cornmeal_dumplings_sauce, &ginger_root, "5 ml");
add_serving(&cornmeal_dumplings_sauce, &garlic, "2, minced");
add_serving(&cornmeal_dumplings_sauce, &arrowroot_starch, "5 g");
add_part(&cornmeal_dumplings, &cornmeal_dumplings_sauce);
...
Recipe curried_lentil_rice_loaf = create_recipe("curried lentil rice loaf", sidedish, "1 small loaf", 20260811, 60);
set_description(&curried_lentil_rice_loaf, "<p>This is a recipe we developed this summer to cook some of our favorite legumes and grains faster. Grinding brown lentils, chickpeas, buckwheat and rice into flour greatly reduces cooking time. We grind the flour in advance and keep them in jars. When we are ready to cook, we mix the chosen flour with water and add a variety of spices and fresh vegetables before cooking the mixture in our solar-oven. The result is a savory loaf which we cut into slices and throw on top of other meals to add bulk.</p><p>Since we have started grinding flour ahead of time, we have been consuming a lot more legumes. We are fairly active in the summer, so preparing this dish has helped keep us fuller, longer.</p><p><b>Grain Mill</b>. We grind whole foods into flour ourselves with a <a href='../media/pages/tools/grinder.jpg'>hand-operated grain mill</a>, milling small quantities so they don't turn rancid. Buckwheat, lentils and rice are very easy to grind at a fine setting, but wheat berries and chickpeas require two passes: the first is at a coarse setting, the second at a fine setting. Trying to mill chickpeas into a find grind from whole will make it very difficult to turn the mill handle.</p><p><b>Solar-oven</b>. Aboard Pino we use a <a href='https://100r.ca/site/solar_evacuated_tube_cooking.html'>solar-evacuated tube</a> as an oven, which cooks a small amount of food very fast on a sunny day. If using other solar-cooking methods, it will take more time to prepare this recipe. It is possible to prepare all of our solar-cooked recipes in a regular oven. Although for this one, doubling the recipe might be necessary since the below ratios are optimized for a smaller cooker(the inside of the tube doesn't permit for large recipes, it feeds two people). Preheat oven to 180°C|350°F, oil up baking dish, pour in batter, and bake for 40 minutes or until slightly browned.</p><p><b>Fresh vegetables?</b> We like to add fresh vegetables into the mix. We cut carrots, potatoes, or onions into really small cubes. We have added sprouted legumes and seeds(see <a href='sprouting.html'>sprouting</a>), our usual mix includes brown lentils, fenugreek seeds, mung beans and radish seeds.</p>");
RecipePart curried_lentil_rice_loaf_batter = create_part("batter");
add_instruction(&curried_lentil_rice_loaf_batter, "In a bowl, mix <i>40 g (1/4 cup)</i> of <a href='rice_flour.html'>rice flour</a>(ground rice, we alternate between short grain glutinous rice, or non-glutinous rice, brown and white), <i>70 g (1/2 cup)</i> of <a href='brown_lentils.html'>lentil flour</a>(ground brown lentils, we've prepared this recipe with chickpea flour too), <i>2.5 g (~1/4 cup)</i> <a href='dried_fenugreek_leaves.html'>dried fenugreek leaves</a>(kasoori methi), <i>1 g (1/2 tsp)</i> <a href='curry_powder.html'>curry powder</a>, <i>1 g (1/2 tsp)</i> <a href='garlic_powder.html'>garlic powder</a>, and <i>2 g (1 tsp)</i> <a href='chili_pepper_flakes.html'>chili pepper flakes</a>. Mix well.");
add_instruction(&curried_lentil_rice_loaf_batter, "Mix in <i>180 ml (3/4 cup)</i> of <a href='water.html'>water</a>(or vegetable broth) gradually, stirring all the while. Do not add the water all at once, depending on how fine your flour is, or what kind of rice you are using, you may require more or less of it. The goal is to have a dough that is wet but that can still hold itself together(not too runny). Stir <i>15 g (1 tbsp)</i> <a href='tahini.html'>tahini</a> into the wet mixture.");
add_instruction(&curried_lentil_rice_loaf_batter, "We like to line the tray of the cooker with a strip of parchment paper so it doesn't stick, and then spoon the batter over it. <img src='../media/recipes/curried_lentil_rice_loaf_2.jpg' loading='lazy'>");
add_instruction(&curried_lentil_rice_loaf_batter, "We solar-cook the mixture for <u>40-60 minutes</u>(depends how sunny it is). We flip the loaf horizontally in the tray about halfway through the cooking process. In the end, the loaf will smell fragrant, notes of fenugreek leaves will wander in from outside, and the edges and top of the loaf will have browned.");
add_instruction(&curried_lentil_rice_loaf_batter, "Cut the loaf into slices and serve them on top of other dishes, we like to put them on top of rice bowls or pasta.");
add_serving(&curried_lentil_rice_loaf_batter, &rice_flour, "40 g");
add_serving(&curried_lentil_rice_loaf_batter, &brown_lentils, "70 g (dry, ground into flour)");
add_serving(&curried_lentil_rice_loaf_batter, &dried_fenugreek_leaves, "2.4 g");
add_serving(&curried_lentil_rice_loaf_batter, &curry_powder, "1 g");
add_serving(&curried_lentil_rice_loaf_batter, &garlic_powder, "1 g");
add_serving(&curried_lentil_rice_loaf_batter, &chili_pepper_flakes, "2 g");
add_serving(&curried_lentil_rice_loaf_batter, &water, "180 ml");
add_serving(&curried_lentil_rice_loaf_batter, &tahini, "15 g");
add_part(&curried_lentil_rice_loaf, &curried_lentil_rice_loaf_batter);
...
set_description(&halloween_pumpkin_cookies, "<p>These cookies are not overly sweet due to the addition of coconut sugar which has a subtle and more complex taste. Coconut sugar and the spelt flour will make your cookies a darker shade of orange, almost brown, but we think it fits nicely with the toned-down color of the pumpkin seeds. If you want a clear orange color, use 100&#37; all-purpose flour and white cane sugar instead.</p><p><b>Leftover chocolate:</b> This recipe makes more chocolate than is needed for the recipe. If you want to keep it for later, pour it in a chocolate mold or shallow container and put it in the freezer. It will become solid and you'll have delicious homemade chocolate on the side for later. Once it's solid, pop it out of the mold and put it in a closed container. Keep it in the freezer until you're ready to eat it!</p><p><b>Pumpkin puree:</b> Remove the seeds and stringy flesh from the pumpkin. Cut the pumpkin into large chunks and place on a baking sheet. Preheat the oven at 180 °C (350 ºF). Roast the chunks for 45 minutes until soft and tender. Let cool. Remove skin, and process into a food processor or use a handstick blender. If pumpkin puree is too wet, strain liquid through cheesecloth, if too dry, add a bit of water. The puree keeps for 3 days in the fridge, and up to 3 months frozen.</p>");
...
add_instruction(&halloween_pumpkin_cookies_cookie_dough, "Stir <i>60 g (1/2 cup)</i> of <a href='all_purpose_flour.html'>all purpose flour</a>, <i>50 g (1/2 cup)</i> of <a href='spelt_flour.html'>spelt flour</a>, <i>2 g</i>(1/4 tsp) of <a href='cinnamon.html'>cinnamon</a>, <i>2 g</i>(1/4 tsp) of <a href='ginger_root_powder.html'>ginger root powder</a>, <i>7 g (1 1/2 tsp)</i> of <a href='baking_powder.html'>baking powder</a>, and a <i>pinch</i> of <a href='baking_soda.html'>baking soda</a> together in a bowl.");
add_instruction(&halloween_pumpkin_cookies_cookie_dough, "See above description to make your own pumpkin puree.");
add_instruction(&halloween_pumpkin_cookies_cookie_dough, "In another bowl, add <i>122g (1/2 cup)</i> of pureed <a href='pumpkin.html'>pumpkin</a>, <i>(3 tbsp) 45 ml</i> of <a href='canola_oil.html'>canola oil</a>(coconut oil is ok too) and <i>70 g (1/2 cup)</i> of <a href='coconut_sugar.html'>coconut sugar</a>. Stir everything together until smooth and well incorporated.");
add_instruction(&halloween_pumpkin_cookies_cookie_dough, "Add the wet to the dry ingredients, mix with a spoon until you get a soft and consistent dough. It will be sticky, but not overly so. Let the dough rest for <u>10 minutes</u>.");
add_instruction(&halloween_pumpkin_cookies_cookie_dough, "Line a baking sheet with a baking mat. Make little balls of dough with your hands, as round as you can make them, and flatten each one gently. Decorate the top end of each ball (nearer to the base of the ball) with <i>3</i> <a href='pumpkin_seeds.html'>pumpkin seeds</a>, sticking them at the top (pointy end in). It's also possible to add them after baking, but this guarantees that the pumpkin seeds stick to the cookie. Bake for <u>15 minutes</u>.");
add_instruction(&halloween_pumpkin_cookies_cookie_dough, "Bake for <u>15 minutes</u>. Let cool completely on baking sheet before moving.");
...
add_serving(&halloween_pumpkin_cookies_cookie_dough, &cinnamon, "2 g");
add_serving(&halloween_pumpkin_cookies_cookie_dough, &ginger_root_powder, "2 g");
add_serving(&halloween_pumpkin_cookies_cookie_dough, &baking_powder, "7 g");
add_serving(&halloween_pumpkin_cookies_cookie_dough, &baking_soda, "pinch");
...
Recipe solar_roasted_kinako = create_recipe("solar roasted kinako", toppings, "185 g", 20260520, 30);
set_description(&solar_roasted_kinako, "<p>In the winter aboard <a href='https://100r.ca/site/pino.html'>Pino</a> we add soymilk to our morning oatmeal so we stay full longer, we don't have a fridge but the area under the sink is cold during that time of year. We cannot drink soy milk in the summer, since it doesn't keep. We've been wondering what we can add as an alternative in the summer, this year we had an idea: what about kinako?</p><p>Kinako(golden flour) is roasted soybean flour. Both of us love kinako, we ate it often when living in Japan. It is nutty, tasty and because it's soy, there's some protein in it(although, it is important to note that it isn't as <a href='https://www.cerealsgrains.org/publications/cc/backissues/1995/Documents/72_401.pdf'>bioavailable</a> as cooked soybeans), which makes it a good summer-time add-on to morning oatmeal when we don't have access to soymilk.</p><p>Kinako is hard to source here in B.C. Canada, but it is possible to find soybeans. Once you have beans, the next step is to roast them.</p><img src='../media/recipes/kinako4.jpg' loading='lazy'><p>We don't have an oven at home, but in the summer we use our solar cooker to roast, steam and bake. We have a <a href='https://100r.ca/site/solar_evacuated_tube_cooking.html'>solar-evacuated tube</a>(pictured above), which concentrates the heat and cooks food with the sun very fast on sunny days.</p><p>Note that it's possible to cook this using a regular oven, we provided instructions for both(thank you <a href='https://norecipes.com/kinako-roasted-soybean-powder/#recipe' target='_blank'>Marc Matsumoto</a> for the instructions for the oven version). Evidently, we did not invent kinako, but it's a reminder that it's possible to make at home.</p>");
RecipePart solar_roasted_kinako_roast = create_part("roast");
add_instruction(&solar_roasted_kinako_roast, "Place <i>135 g(3/4 cup)</i> of <a href='soy_beans.html'>dry soybeans</a> in the tray of the solar-cooker. Or if you have an oven, spread the beans on a baking tray and preheat the oven to <u>180°C (355°F)</u>.");
add_instruction(&solar_roasted_kinako_roast, "Solar-roasting time varies depending on local conditions, but it if it's sunny it shouldn't take longer than <u>30 minutes</u>. Check the beans often to make sure they don't burn. When the beans start to smell nutty, open the tray and shake the beans a little so they roast evenly. When ready, the outer skin of the beans will split and the inside will turn a golden color. Note that the outside will not brown as much as the insides. The browner the bean, the nuttier the kinako. If using an oven, roast for <u>10-15 minutes</u>, shaking halfway to make sure they're evenly roasted.");
add_instruction(&solar_roasted_kinako_roast, "Transfer the roasted beans into a bowl, let cool.<img src='../media/recipes/kinako2.jpg'/>");
add_instruction(&solar_roasted_kinako_roast, "Once cooled off, grind the beans(skins and all) into a fine powder. We use our hand coffee grinder to do it. Roasted beans are more brittle, therefore easy to grind. <img src='../media/recipes/kinako3.jpg'/>");
add_instruction(&solar_roasted_kinako_roast, "Keep in a cool dry place, sprinkle over desserts, or spoon into morning oatmeal.");
add_serving(&solar_roasted_kinako_roast, &soy_beans, "135 g (3/4 cup)");
add_part(&solar_roasted_kinako, &solar_roasted_kinako_roast);
...
// soybean coffee
Recipe soybean_coffee = create_recipe("soybean coffee", sidedish, "180 g", 20260608, 45);
set_description(&soybean_coffee, "<p>We once had a vegetarian cookbook aboard by Louise Hagler that mentioned coffee made from soybeans, although their recipe was very short and devoid of detail. The authors grew their own soy, and made a variety of dishes using it as a base. As you know, we have been experimenting with soybeans ourselves a lot this year, and we finally roasted some to make a coffee alternative. The first time was an accident, after over-roasting beans for <a href='solar_roasted_kinako.html'>kinako</a>(a pleasant error).</p><p>Soybean coffee smells and tastes like kinako, it is sweet and nutty. It is a very good, caffeine-free, and inexpensive alternative to coffee(we prefer it to chicory). Note that we are not coffee experts, and we tend to use simple tools.</p><p>We solar-cook our beans using a <a href='https://100r.ca/site/solar_evacuated_tube_cooking.html'>solar-evacuated tube</a>, but here are instructions for other ways to prepare them.<br><b>Oven instructions:</b> Spread the beans on a baking tray, one bean deep, and preheat the oven to <u>150°C (300°F)</u>, roast for 25-30 minutes, shaking the beans every 10 minutes so they brown somewhat evenly. You may have to roast them for longer, depending on your oven. To be fair, all of the method listed here will likely not result in perfect even browning, if you want this you're better off getting a proper roaster, but personally, we are very content with the flavor of unevenly roasted beans.<br><b>Stovetop:</b> Preheat the pan over medium-high heat. When a droplet of water fizzes away fairly quickly, but not immediately, add the dry soybeans. Stir constantly to prevent scorching. This method may smoke up the room... have a window or fan running. Roast until the inside bean is dark brown.</p>");
RecipePart soybean_coffee_roast = create_part("roast");
add_instruction(&soybean_coffee_roast, "Place <i>180 g(1 cup)</i> of <a href='soy_beans.html'>dry soybeans</a> in the tray of the solar-cooker.");
add_instruction(&soybean_coffee_roast, "Solar-roasting time varies depending on local conditions, but it if it's sunny it shouldn't take longer than <u>45 minutes</u>. Check the beans often to make sure they don't burn. When the beans start to smell nutty, open the tray and shake the beans a little so they roast evenly. We shake every 15 minutes or so. When ready, the outer skin of the beans will split and the inside will turn a dark brown color. Note that the outside will not brown as much as the insides, but for coffee they will turn a light brown color. Below is a photo of two different soybean roasts, left is for soybean coffee, right is for <a href='kinako.html'>kinako</a>. <img src='../media/recipes/soybean_coffee_03.jpg'/>");
add_instruction(&soybean_coffee_roast, "Transfer the roasted beans into a bowl, let cool.");
add_instruction(&soybean_coffee_roast, "Once cooled off, grind the beans(skins and all) in a grain or coffee grinder (we use a ceramic-burred hand grinder). The resulting grains are softer to grind than some coffee roasts we've had. <img src='../media/recipes/soybean_coffee_01.jpg'/>");
add_instruction(&soybean_coffee_roast, "Keep in a cool dry place. Brew as you would a regular cup of coffee (1 tbsp grounds per cup of water). <img src='../media/recipes/soybean_coffee_02.jpg'/>");
add_serving(&soybean_coffee_roast, &soy_beans, "180 g (1 cup)");
add_part(&soybean_coffee, &soybean_coffee_roast);
...
set_description(&wakame_bites, "<p>A great snack packed with a good dose of iodine, necessary for good health.</p><p>We used some cookie cutters, but most times we just cut the sheets of dough into small squares with a regular knife. Using cookie cutters isn't as efficient because we want to use every bit of the dough and that means re-using the bits around the cut-outs.</p><p>The cookies were adapted from a recipe by <a href='http://www.food-sommelier.jp/recipe/R0123/173155.html' target='_blank'>Kiuchi Yuki-san</a></p>");
