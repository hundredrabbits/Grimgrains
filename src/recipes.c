...
add_instruction(&anise_bread_with_sweet_pear_sauce_sauce, "Heat a pan at medium to high heat, add <i>60 ml (1/4 cup)</i> of <a href='canola_oil.html'>unrefined canola oil</a>. Once melted, add <i>15 g (1 tbsp)</i> of <a href='granulated_sugar.html'>sugar</a> and <i>15 ml (1 tbsp)</i> of <a href='maple_syrup.html'>maple syrup</a>.");
...
add_instruction(&black_sesame_rice_pancakes_pancakes, "Heat up non-stick pan at medium heat, add <i>15 ml (1 tbsp)</i> of <a href='canola_oil.html'>unrefined canola oil</a>. Spoon about <i>60 ml (1/4 cup)</i> of batter into the pan. Flip once the bottoms have browned, and little bubbles appear at the top.");
...
// golden bread
Recipe golden_bread = create_recipe("golden bread", breakfast, "2 servings", 20200214, 15);
...
add_instruction(&veganaise_veganaise, "Place the <i>250 g (1 cup)</i> of <a href='soft_tofu.html'>soft tofu</a>, <i>15 ml (1 tbsp)</i> <a href='apple_cider_vinegar.html'>apple cider vinegar</a>, <i>30 g (2 tbsp)</i> <a href='dijon_mustard.html'>dijon mustard</a> and <i>1.25 g (1/4 tsp)</i> <a href='salt.html'>salt</a> in a blender and process until smooth. Add <i>60 ml (4 tbsp)</i> of <a href='canola_oil.html'>unrefined canola oil</a>, and continue to blend for <u>1-2 minutes</ul>.");
...
set_description(&raisin_beet_bread, "I present to you a sweet bread that you can have in the morning for breakfast, or as a dessert.<br /><br />If like my dad you like raisin bread, you will love this sweet raisin beet bread. It's halfway between a cake and bread. Adapted from one of my mom's old cookbook by Margo Oliver <b>les menus de margo oliver</b>.<br /><br />It's simple to make, and you can replace the raisins with currants or cranberries. If you make my recipe, just be sure to add plenty of raisins on top! I emptied a bag on it, without regret. They'll get super crispy, and will develop a sweet crispy caramelized taste. Was hard to keep myself from picking them off, Devine hates it when I do that.<br /><br />");
...
Recipe roasted_eggplant_dip = create_recipe("roasted eggplant dip", toppings, "4 servings", 2090206, 50);
