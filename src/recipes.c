// // rejuvelac
// Recipe rejuvelac = create_recipe("rejuvelac", basic, "2 mini loaves", 20200112, 40);
// set_description(&rejuvelac, "<p>Since getting those mini silicone pans, we've been making mini everything. This time, we made some anise sweet bread topped with a sauce, and loaded with caramelized pear chunks.</p><p>My bag of anise seeds has been sitting in my pantry, for way too long, begging for purpose. We are happy to report that the taste of anise pairs very well with pears.</p>");
// RecipePart rejuvelac_base = create_part("base");
// add_instruction(&rejuvelac_base, "Soak wheat berries for 8-14 hours, for a duration of 1-1/2 days. You can sprout using the cloth or jar method, to find out how to do either of these follow these <a href'sprouting.html#jarscloth'>instructions</a>. Sprout grains, rinsing 2-3 times daily, until the wheat berries sprout little tails.");
// add_instruction(&rejuvelac_base, "Transfer sprouted wheat berries to clean jar, and cover with 1.5 cups of water. Cover loosely, with a cloth or lid, and leave in a warm place for 2-3 days. The water will turn cloudy, and develop a tart flavor.");
// add_instruction(&rejuvelac_base, "Strain wheat berries, and use rejuvelac in other recipes. The liquid will keep a few weeks if kept in a cool place.");
// add_instruction(&rejuvelac_base, "Pour the wet ingredients into the dry ones, while gradually adding a bit over <i>150 ml</i> of <a href='soy_milk.html'>soy milk</a>.");
// add_instruction(&anise_, "Transfer evenly, to 2 mini loaf pans.");
// add_serving(&rejuvelac_base, &wheat_berries, "184 g");
// add_serving(&rejuvelac_base, &water, "45 ml");
// add_part(rejuvelac, rejuvelac_base);
...
//sheperd's pie
Recipe sheperds_pie = create_recipe("sheperds pie", maindish, "4 servings", 20150310, 40);
set_description(&sheperds_pie, "<p>Sheperds pie is one of our favorite childhood meals. It's a super versatile dish, our recipe has layers consisting of tofu and burmese tofu, green peas, sweet potato and cauliflower.</p><p>Shepherd's pie is very much like Pâté Chinois, everyone in Quebec refers to this dish as such, but because I suspect it has racist origins (no one is entirely sure where the name comes from) I'm going to refrain from using that term.</p><p>Families in Quebec make this all the time, but the traditional version includes meat and creamed corn. This recipe is different, but inspires the same kind of comfort.</p><p><b class='head'>Substitutions:</b></p><p>We've made versions of this dish with just cauliflower, or just using tofu, or just potatoes too. We've made it so often we've gone through every possibility. All in all, it consists of a <b>protein layer</b> (tofu, burmese tofu, lentils etc) <b>veggie layer</b> (corn or peas), and topped with a <b>root or hearty vegetable layer</b> (potatoes, pumpkin, parnisps, cauliflower etc).</p><p>I've also made a version which consists of cubed, cooked potatoes (or pumpkin), with scrambled chickpea flour and corn.</p>");
RecipePart sheperds_pie_sheperds_pie = create_part("pate chinois");
add_instruction(&sheperds_pie_sheperds_pie, "Preheat oven to <u>190 °C (375 °F)</u>.");
add_instruction(&sheperds_pie_sheperds_pie, "Cut <i>1 large</i> <a href='sweet_potato.html'>sweet potato</a> into cubes, and chop <i>1 head</i> <a href='white_cauliflower.html'>white cauliflower</a> into bite-sized pieces. Bring a pot of <a href='water.html'>water</a> (or <a href='vegetable_bouillon.html'>vegetable bouillon</a> for added flavor) to a boil, add chopped sweet potato and cauliflower and cook until tender.");
add_instruction(&sheperds_pie_sheperds_pie, "Drain, mix with <i>5 g (1 tsp)</i> of <a href='smoked_paprika.html'>smoked paprika</a>, and purée with an immersion blender. Season with <i>1.25 g</i> of <a href='salt.html'>salt</a> and <a href='black_pepper.html'>black pepper</a>. Set aside.");
add_instruction(&sheperds_pie_sheperds_pie, "Take <i>454 g (1 block)</i> of firm <a href='tofu.html'>tofu</a>, cut it into fours, then mash it down using your hands. I like to squish the tofu down with my fingers to get a crumbly texture. You can also grate the tofu with a grater. (For a soy-free Pâté Chinois you can also use <a href='Sweet_Mock_Eel_Nigiri.html'>burmese tofu</a>.)");
add_instruction(&sheperds_pie_sheperds_pie, "In a large pan, brown <i>1 small</i> <a href='yellow_onion.html'>yellow onion</a> with <i>5 ml (1 tsp)</i> of <a href='olive_oil.html'>olive oil</a>. Add the <a href='tofu.html'>crumbled tofu</a>, <i>30 ml (2 tbsp)</i> of <a href='soy_sauce.html'>soy sauce</a> and <i>1 drop</i> of <a href='liquid_smoke.html'>liquid smoke</a>. Cook for a few minutes. Season with black pepper and sea salt.");
add_instruction(&sheperds_pie_sheperds_pie, "When cooked, press tofu mix into bottom of an ~8x8 baking dish.");
add_instruction(&sheperds_pie_sheperds_pie, "Cover tofu mix with the contents of <i>400 g (1 can)</i> of of <a href='green_peas.html'>green peas</a> (reserve a few for the top) and top with the puréed cauliflower/sweet potato mixture.");
add_instruction(&sheperds_pie_sheperds_pie, "Smooth with a spatula, decorate with some <a href='green_peas.html'>green peas</a> and sprinkle with <a href='smoked_paprika.html'>smoked paprika</a>.");
add_instruction(&sheperds_pie_sheperds_pie, "Bake for <u>30 minutes</u>, then broil on high for <u>3-5 minutes</u> to brown the top. Let rest for <u>10 minutes</u> before serving.");
add_instruction(&sheperds_pie_sheperds_pie, "Serve with some <a href='sambal_oelek.html'>sambal oelek</a> or some other spicy condiment! Keeps in the fridge for 5 days or can be frozen for 2-3 months.");
add_serving(&sheperds_pie_sheperds_pie, &white_cauliflower, "1 head, small");
add_serving(&sheperds_pie_sheperds_pie, &sweet_potatoes, "1, large");
add_serving(&sheperds_pie_sheperds_pie, &green_peas, "400 g");
add_serving(&sheperds_pie_sheperds_pie, &tofu, "454 g, firm");
add_serving(&sheperds_pie_sheperds_pie, &soy_sauce, "30 ml");
add_serving(&sheperds_pie_sheperds_pie, &yellow_onion, "1, small");
add_serving(&sheperds_pie_sheperds_pie, &smoked_paprika, "5 g");
add_part(&sheperds_pie, &sheperds_pie_sheperds_pie);
