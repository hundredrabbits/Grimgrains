...
add_instruction(&chocolate_turtles_preparation, "Remove the pits from <i>400 g (about 50 dates)</i> of <a href='dates.html'>deglet noor dates</a>, chop off the stems, and then chop the dates into smaller pieces. Steam the chopped dates on the stovetop for <u>10 minutes</u> using a double boiler(with steam basket), or by soaking the dates in hot water. Heating up the dates makes it easier to grind them into a puree.");
add_instruction(&chocolate_turtles_preparation, "Transfer the softened dates into a food processor, and blend them into a puree. Add <i>45 g</i> of <a href='tahini.html'>tahini</a> to the puree, and blend again. Set aside.");
add_instruction(&chocolate_turtles_preparation, "Pour <i>3 cm (1 inch)</i> of water into a pan and bring up to medium heat. In the meantime,  transfer <i>200 g (a bit over 1 cup)</i> of chopped <a href='dark_chocolate.html'>dark chocolate</a> into a heat-proof bowl(not plastic). When the water in the pan is hot, add the bowl, the simmering water will melt the chocolate without burning it. Stir in <i>15 ml(2 tbsp)</i> of <a href='coconut_oil.html'>coconut oil</a>. When the chocolate is smooth and uniform, remove the bowl from the heat, and pour 24 spoonfuls of chocolate chocolate over the parchment paper(leaving some space in-between each one). Using the back of a spoon, spread the chocolate into a rough 5 cm circle. This is the base of the turtle, you can also coat the underside later(see the last step).");
add_instruction(&chocolate_turtles_preparation, "The pureed dates mixture will be very sticky, we like to keep a bowl of water nearby and to occasionally dip our hands in it(shaking off the excess) to handle it. Pick up enough mixture with your hands to form a small ball(2.5 cm | 1 inch), flatten them into thick discs, then place one on each 5 cm chocolate circle.");
