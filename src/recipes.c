...
Recipe *recipes[] = {&anise_bread_with_sweet_pear_sauce, &arame_soba, &balsamic_banana_ice_cream, &black_sesame_brittle, &black_sesame_rice_pancakes, &black_sesame_syrup, &breaded_veggie_fingers, &carrot_kinpira_onigirazu, &cheese, &cheese_and_spinach_ravioli, &basic_black_bread, &basic_toothpaste, &beer_bread, &borscht_with_tofu_sour_cream, &breadfruit_gnocchi, &breadfruit_pasta, &buckwheat_tea, &chickpea_salad_sandwich, &chili_pomegranate_brownies, &chocolate_chip_cookies, &coffee_jelly, &corn_dumplings, &crackers, &dark_gyoza, &fresh_pesto_pasta, &halloween_pumpkin_cookies, &homemade_veganaise, &hop_ice_cream, &houjicha_overnight_oatmeal, &lentils_with_roasted_beet_sauce, &mason_jar_bread_pudding, &mushroom_zucchini_pasta, &mustard_from_seed, &no_knead_bread, &okonomiyaki, &pandanus_fruit_bread, &pan_fried_breadfruit, &papaya_bruschetta_topping, &pate_chinois, &persimmon_curry, &potato_gnocchi, &quick_sunflower_seed_parmesan, &raisin_beet_bread, &roasted_carrots_with_beluga_lentils, &roasted_pumpkin_seeds, &scrambled_chickpeas, &sunflower_heirloom_carrot_pasta, &sweet_mock_eel_nigiri, &teriyaki_veggie_patties, &turmeric_cookies, &tzaziki, &salted_caramel_carob_chip_cookies, &seitan, &shichimi_togarashi_crackers, &spicy_stirfry_chickpeas, &spinach_oatmeal_cookies, &spinach_pajeon, &stovetop_popcorn, &sweet_and_sour_lentils, &uzumaki_hummus_bites, &vegemite_caramel, &veggie_pate, &wakame_bites, &wasabi_swirl_chocolate_cookies };
