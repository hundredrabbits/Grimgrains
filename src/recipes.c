...
add_instruction(&raisin_beet_bread_sweet_bread, "Put <i>175 g (1 cup)</i> of <a href='dried_raisins.html'>dried raisins</a> in a bowl, cover with <i>240 ml (1 cup)</i> of <a href='warm_water.html'>warm water</a>. Let cool, then add <i>2.5 ml (1/2 tsp)</i> of <a href='vanilla_extract.html'>vanilla extract</a>.");
...
add_instruction(&raisin_beet_bread_sweet_bread, "Mix <i>30 ml (2 tbsp)</i> of <a href='ground_flax_seeds.html'>ground flax seeds</a> with <i>90 ml (6 tbsp)</i> of <a href='water.html'>water</a>, let thicken. In a separate bowl, measure out <i>60 ml (1/4 cup)</i> of <a href='canola_oil.html'>canola oil</a>. Add <i>65g (1/3 cup)</i> of <a href='whole_cane_sugar.html'>whole cane sugar</a>, gradually, mixing at the same time. In that same bowl, add the <a href='flax_seeds.html'>flax seeds</a> and the <a href='puréed_beets.html'>puréed beets</a>. This is the sweet part of our bread: the cream.");
add_instruction(&raisin_beet_bread_sweet_bread, "Mix your dry ingredients together, <i>270 g (2 1/4 cups)</i> of <a href='all_purpose_flour.html'>all purpose flour</a>, the <i>2.5 ml (1/2 tsp)</i> of <a href='salt.html'>salt</a> and <i>15 ml (1 tbsp)</i> of <a href='baking_soda.html'>baking soda</a>.");
...
add_instruction(&raisin_beet_bread_sweet_bread, "Add spoonfuls of the wet dough to your greased pan, add the remaining <i>45 g (1/4 cup)</i> of <a href='dried_raisins.html'>dried raisins</a> on the top of the dough. Push down gently to make sure they stick.");
...
add_serving(&raisin_beet_bread_sweet_bread, &dried_raisins, "220 g");
...
add_serving(&raisin_beet_bread_sweet_bread, &sea_salt, "2.5 ml");
...
add_instruction(&persimmon_curry_rice, "Boil some water, pour <i>180 ml</i> of it over the rice. Bring pot to a boil. Add <i>2.5 ml (1/2 tsp)</i> of <a href='salt.html'>salt</a>, and <i>1</i> <a href='bay_leaf.html'>bay leaf</a>, lower heat and cover. Simmer for <u>15 minutes</u>, remove from heat and let steam for an additional <u>5 minutes</u> with the lid on.");
...
add_serving(&persimmon_curry_rice, &salt, "2.5 ml");
...
add_instruction(&persimmon_curry_sauce, "Sauté <i>1 chopped</i> <a href='onion.html'>yellow onion</a>, <i>2 minced</i> <a href='garlic.html'>garlic cloves</a>, <i>5 ml (1 tsp)</i> of grated <a href='ginger_root.html'>ginger root</a> with a bit of <a href='olive_oil.html'>olive oil</a> in a pan over medium heat. Cook until onions become translucent.");
add_instruction(&persimmon_curry_sauce, "Add <i>2 diced</i> <a href='carrots.html'>carrots</a>,<i>15 g (handful)</i> of <a href='spinach.html'>spinach</a>. Stir for <u>2 minutes</u>, then add <i>15 ml (1 tbsp)</i> of <a href='curry_powder.html'>curry powder</a>. Cook for an additional minute.");
...
add_serving(&persimmon_curry_sauce, &sea_salt, "1.25 ml");
...
add_instruction(&mason_jar_bread_pudding_bread_pudding, "Sprinkle <i>5 ml (1 tsp)</i> of <a href='brown_sugar.html'>brown sugar</a> on top, decorate with apple slices (use the other half of the <a href='apple.html'>apple</a>), add <i>1.25 ml (1/4 tsp)</i>, <a href='cinnamon.html'>cinnamon</a> and <i>15 ml (1 tbsp)</i> of <a href='maple_syrup'>maple syrup</a> overtop.");
...
add_serving(&mason_jar_bread_pudding_bread_pudding, &cinnamon, "1.25 ml");
...
add_instruction(&basic_black_bread_bread, "In a large bowl, stir <i>15 ml (1 tbsp)</i> of <a href='maple_syrup.html'>maple syrup</a> in <i>240 ml (1 cup)</i> of <a href='warm_water.html'>warm water</a> until dissolved. Sprinkle <i>5 ml (1 tsp)</i> of <a href='active_dry_yeast.html'>active dry yeast</a>, let sit for <u>10 minutes</u>.");
...
add_instruction(&basic_black_bread_bread, "Take buns out of oven, brush lightly with <i>15 ml (1 tbsp)</i> of <a href='coconut_oil.html'>coconut oil</a> (for browning) and put <a href='white_sesame_seeds.html'>white sesame seeds</a> on top. Bake uncovered for <u>20 minutes</u> at <u>180°C (350°F)</u>.");
...
add_serving(&basic_black_bread_bread, &salt, "7 ml");
...
add_instruction(&shichimi_togarashi_crackers_crackers, "In a bowl, combine <i>120 g (1 cup)</i> <a href='chickpea_flour.html'>chickpea flour</a>, <i>15 ml (1 tbsp)</i> <a href='ground_flax_seeds.html'>ground flax seeds</a>, <i>1.25 ml (1/4 tsp)</i> of <a href='baking_soda.html'>baking soda</a>, <i>7 ml (1 1/2 tsp)</i> <a href='sesame_oil.html'>sesame oil</a>, <i>1.25 ml (1/4 tsp)</i> of <a href='sea_salt.html'>sea salt</a> and <i>15 ml (3 tsp)</i> <a href='shichimi_togarashi.html'>shichimi togarashi</a>.  Stir in <i>60 ml (1/4 cup)</i> of <a href='water.html'>water</a>, mix until well combined and form into a ball. Add extra chickpea flour if the dough is too sticky, 15 ml at a time.");
...
add_serving(&shichimi_togarashi_crackers_crackers, &baking_soda, "1.25 ml");
...
add_serving(&shichimi_togarashi_crackers_crackers, &sea_salt, "1.25 ml");
...
add_instruction(&potato_gnocchi_gnocchi, "Sift <i>150g (1 1/4 cup)</i> of <a href='whole_wheat_flour.html'>whole wheat flour</a>, <i>15 ml (1 tbsp)</i> <a href='bamboo_charcoal_powder.html'>bamboo charcoal powder</a> and <i>1.25 ml (1/4 tsp)</i> of <a href='salt.html'>salt</a> together in a bowl.");
...
add_serving(&potato_gnocchi_gnocchi, &sea_salt, "1.25 ml");
add_part(&potato_gnocchi, &potato_gnocchi_gnocchi);
RecipePart potato_gnocchi_sauce = create_part("sauce");
add_instruction(&potato_gnocchi_sauce, "Mix <i>90 ml (6 tbsp)</i> of <a href='soy_sauce.html'>soy sauce</a>, <i>45 ml (3 tbsp)</i> of <a href='mirin.html'>mirin</a> and <i>20 ml (4 tsp)</i> of <a href='granulated_sugar.html'>sugar</a> in a bowl.");
add_serving(&potato_gnocchi_sauce, &soy_sauce, "90 ml");
add_serving(&potato_gnocchi_sauce, &mirin, "45 ml");
add_serving(&potato_gnocchi_sauce, &granulated_sugar, "20 ml");
add_part(&potato_gnocchi, &potato_gnocchi_sauce);
RecipePart potato_gnocchi_toppings = create_part("toppings");
add_instruction(&potato_gnocchi_toppings, "Rehydrate <i>45 ml (3 tbsp)</i> of <a href='wakame.html'>wakame</a> as well in a separate cup. Let stand for <u>5 minutes</u>, drain, rinse and cut into smaller pieces.");
add_instruction(&potato_gnocchi_toppings, "Chop up <i>5 stalks</i> <a href='scallions.html'>scallion stalks</a> and grate <i>5 cm</i> of <a href='daikon.html'>daikon</a>. Squeeze water out of daikon, and set aside.");
...
add_serving(&lentils_with_roasted_beet_sauce_sauce, &sea_salt, "1.25 ml");
add_serving(&lentils_with_roasted_beet_sauce_sauce, &black_pepper, "1.25 ml");
...
add_serving(&lentils_with_roasted_beet_sauce_sauce, &nutritional_yeast, "40 g");
...
add_instruction(&teriyaki_veggie_patties_sauce, "Mix <i>30 ml (2 tbsp)</i> of <a href='soy_sauce.html'>soy sauce</a>, <i>30 ml</i> of <a href='sake.html'>sake</a>, <i>30 ml (2 tbsp)</i> of <a href='mirin.html'>mirin</a> and <i>5 ml (1 tsp)</i> of <a href='whole_cane_sugar.html'>whole cane sugar</a>.");
...
add_serving(&teriyaki_veggie_patties_sauce, &whole_cane_sugar, "5 ml");
...
add_instruction(&savoury_turmeric_cookies_cookies, "Mix <i>60 g (1/2 cup)</i> of <a href='all_purpose_flour.html'>all purpose flour</a>, <i>60 g (1/2 cup)</i> of <a href='spelt_flour.html'>spelt flour</a>, <i>7 ml (1 1/2 tsp)</i> of <a href='baking_powder.html'>baking powder</a>, <i>10 ml (2 tsp)</i> of <a href='turmeric_powder.html'>turmeric powder</a> and <i>5 ml (1 tsp)</i> of ground <a href='dried_orange_peels.html'>dried orange peels</a> in a bowl. Stir well to mix.");
...
add_serving(&savoury_turmeric_cookies_cookies, &all_purpose_flour, "60 g");
add_serving(&savoury_turmeric_cookies_cookies, &spelt_flour, "60 g");
add_serving(&savoury_turmeric_cookies_cookies, &baking_powder, "7 ml");
...
add_serving(&savoury_turmeric_cookies_cookies, &canola_oil, "90 ml");
add_serving(&savoury_turmeric_cookies_cookies, &whole_cane_sugar, "100 g");
add_serving(&savoury_turmeric_cookies_cookies, &soy_milk, "90 mold");
...
add_serving(&sweet_mock_eel_nigiri_rice, &sea_salt, "1.25 ml");
...
add_instruction(&sweet_mock_eel_nigiri_sauce, "Mix <i>30 ml (2 tbsp)</i> of <a href='soy_sauce.html'>soy sauce</a>, <i>30 ml (2 tbsp)</i> of <a href='mirin.html'>mirin</a>, <i>15 ml (1 tbsp)</i> of <a href='whole_cane_sugar.html'>whole cane sugar</a> and <i>15 ml (1 tbsp)</i> of <a href='sake.html'>sake</a>.");
...
add_serving(&sweet_mock_eel_nigiri_chickpea_tofu, &chickpea_flour, "120 g");
add_serving(&sweet_mock_eel_nigiri_chickpea_tofu, &sea_salt, "1.25 ml");
add_serving(&sweet_mock_eel_nigiri_chickpea_tofu, &ground_turmeric, "5 ml");
...
add_instruction(&black_sesame_rice_pancakes_pancakes, "In another bowl, mix <i>120 g (~1 cup)</i> of <a href='rice_flour.html'>rice flour</a>, <i>1.25 ml (1/4 tsp)</i> of <a href='salt.html'>salt</a>, <i>5 ml (1 tsp)</i> of <a href='baking_powder.html'>baking powder</a> and <i>15 ml (1 tbsp)</i> of <a href='whole_cane_sugar.html'>whole cane sugar</a> together.");
...
add_serving(&black_sesame_rice_pancakes_pancakes, &rice_flour, "120 g");
...
add_serving(&black_sesame_rice_pancakes_pancakes, &salt, "1.25 ml");
...
add_instruction(&mushroom_zucchini_pasta_veggie_noodles_and_toppings, "Rehydrate <i>30 ml (2 tbsp)</i> of <a href='wakame.html'>wakame</a> in water, drain and set aside.");
...
add_instruction(&mushroom_zucchini_pasta_sauce, "Put <i>30 ml (2 tbsp)</i> of <a href='olive_oil.html'>olive oil</a> in a saucepan over medium heat, whisk in <i>30 ml (2 tbsp)</i> of <a href='all_purpose_flour.html'>all purpose flour</a>. Stir until it's completely absorbed by the oil. Let roux cook for a minute or so.");
...
add_instruction(&pate_chinois_pate_chinois, "Drain, mix with <i>5 ml (1 tsp)</i> of <a href='smoked_paprika.html'>smoked paprika</a>, and purée with an immersion blender. Season with <i>1.25 ml</i> of <a href='salt.html'>salt</a> and <a href='black_pepper.html'>black pepper</a>. Set aside.");
...
add_instruction(&chili_pomegranate_brownies_brownies, "Preheat oven to <u>160°C (325°F)</u>.");
add_instruction(&chili_pomegranate_brownies_brownies, "Cut <i>50 g (~1/3 cup)</i> of <a href='pumpkin.html'>pumpkin</a>, steam until softened and process into a purée.");
add_instruction(&chili_pomegranate_brownies_brownies, "Put <i>45 ml (3 tbsp)</i> of <a href='ground_flax_seeds.html'>ground flax seeds</a> in a bowl with <i>135 ml (9 tbsp)</i> of <a href='water.html'>water</a>. Let thicken for <u>5 minutes</u>. Set aside.");
add_instruction(&chili_pomegranate_brownies_brownies, "Put <i>75 ml (5 tbsp)</i> of <a href='canola_oil.html'>canola oil</a>, the <a href='pumpkin_purée.html'>pumpkin purée</a>, <i>150 g (3/4 cup)</i> <a href='whole_cane_sugar.html'>whole cane sugar</a>, <i>80 g (3/4 cup)</i> <a href='cocoa_powder.html'>cocoa powder</a> and a <i>1.25 ml (1/4 tsp)</i> <a href='salt.html'>salt</a> in a pan over medium to low heat. Stir until well incorporated. Let cool.");
add_instruction(&chili_pomegranate_brownies_brownies, "Stir in the flax 'egg', as well as the <i>30 ml (2 tbsp)</i> of <a href='chili_pepper_flakes.html'>chili pepper flakes</a> and <i>5 ml (1 tsp)</i> of <a href='cayenne_pepper_powder.html'>cayenne pepper powder</a>. Add <i>60 g (1/2 cup)</i> of <a href='all_purpose_flour.html'>all purpose flour</a> and mix well. Mixture should be very thick.");
...
add_serving(&chili_pomegranate_brownies_brownies, &pumpkin, "50 g");
add_serving(&chili_pomegranate_brownies_brownies, &flax_seeds, "45 ml");
add_serving(&chili_pomegranate_brownies_brownies, &water, "135 ml");
add_serving(&chili_pomegranate_brownies_brownies, &canola_oil, "75 ml");
add_serving(&chili_pomegranate_brownies_brownies, &granulated_sugar, "150 g");
add_serving(&chili_pomegranate_brownies_brownies, &cocoa_powder, "80 g");
add_serving(&chili_pomegranate_brownies_brownies, &sea_salt, "1.25 ml");
add_serving(&chili_pomegranate_brownies_brownies, &all_purpose_flour, "60 g");
...
add_serving(&chili_pomegranate_brownies_syrup, &pomegranate_juice, "475 ml");
...
add_instruction(&chili_pomegranate_brownies_topping, "Top brownies with the <a href='pomegranate_seeds.html'>seeds</a>, of two fresh <a href='pomegranate.html'>pomegranates</a> (read about <a href='pomegranate_seeds.html'>a technique</a> on how to remove the seeds) and drizzle with the chili-infused syrup!");
add_serving(&chili_pomegranate_brownies_topping, &pomegranate, "2");
...
add_instruction(&breaded_veggie_fingers_breading_mix, "Mix <i>150 g (1 cup)</i> of dried breadcrumbs with <i>40g (1/4 cup)</i> of <a href='nutritional_yeast.html'>nutritional yeast</a>. Spread out thinly onto a plate.");
...
add_serving(&breaded_veggie_fingers_breading_mix, &panko, "150 g");
add_serving(&breaded_veggie_fingers_breading_mix, &nutritional_yeast, "40 g");
...
add_serving(&uzumaki_hummus_bites_beet_hummus, &sea_salt, "1.25 ml");
...
add_instruction(&uzumaki_hummus_bites_tortillas, "Put <i>360 g (3 cups)</i> of <a href='all_purpose_flour.html'>all purpose flour</a>, <i>5 ml (1 tsp)</i> <a href='bamboo_powder.html'>bamboo powder</a> and <i>5 ml (1 tsp)</i> of <a href='salt.html'>salt</a> in a bowl. Mix well.");
...
add_serving(&anise_bread_with_sweet_pear_sauce_bread, &baking_powder, "7 ml");
...
add_instruction(&anise_bread_with_sweet_pear_sauce_sauce, "Heat a pan at medium to high heat, add <i>60 ml (1/4 cup)</i> of <a href='canola_oil.html'>canola oil</a>. Once melted, add <i>15 ml (1 tbsp)</i> of <a href='granulated_sugar.html'>sugar</a> and <i>15 ml (1 tbsp)</i> of <a href='maple_syrup.html'>maple syrup</a>.");
...
add_instruction(&wasabi_swirl_chocolate_cookies_cookies, "Mix <i>15 ml (1 tbsp)</i> of <a href='ground_flax_seeds.html'>ground flax seeds</a> with <i>45 ml (3 tbsp)</i> of <a href='water.html'>water</a> (this is your 'flax egg'). Let thicken.");
add_instruction(&wasabi_swirl_chocolate_cookies_cookies, "Sautee <i>30 g (1/4 cup)</i> of <a href='black_sesame_seeds.html'>black sesame seeds</a> in a non-stick pan at medium heat, roast until they begin to pop. Let cool.");
...
add_instruction(&wasabi_swirl_chocolate_cookies_cookies, "Take <i>195 g (1 1/2 cups)</i> of <a href='rolled_oats.html'>rolled oats</a>, break it down into 'coarse' flour with a mortar and pestle. Don't grind it too finely, having bigger bits gives an interesting texture to the cookie!");
...
add_serving(&wasabi_swirl_chocolate_cookies_cookies, &black_sesame_seeds, "30 g");
...
add_serving(&wasabi_swirl_chocolate_cookies_cookies, &baking_soda, "7 ml");
add_serving(&wasabi_swirl_chocolate_cookies_cookies, &baking_powder, "7 ml");
add_serving(&wasabi_swirl_chocolate_cookies_cookies, &sea_salt, "1.25 ml");
add_serving(&wasabi_swirl_chocolate_cookies_cookies, &cocoa_powder, "30 ml");
add_serving(&wasabi_swirl_chocolate_cookies_cookies, &rolled_oats, "195 g, ground");
...
add_instruction(&wasabi_swirl_chocolate_cookies_glaze, "Mix <i>50 g (1/2 cup)</i> of <a href='powdered_sugar.html'>powdered sugar</a> and <i>15 ml (1 tbsp)</i> of <a href='wasabi_powder.html'>wasabi powder</a> together.");
...
add_instruction(&hop_ice_cream_hop_ice_cream, "Shake <i>2 378ml cans</i> of <a href='coconut_milk.html'>coconut milk</a> before opening them, full-fat coconut milk separates over time and shaking will help to mix it up again. Reserve a <i>120 ml (1/2 cup)</i> of <a href='coconut_milk.html'>coconut milk</a> for later, put the rest in a pan with <i>120 ml (1/2 cup)</i> of <a href='maple_syrup.html'>maple syrup</a> and <i>1.25 ml (1/4 tsp)</i> of <a href='salt.html'>salt</a>.");
...
add_instruction(&hop_ice_cream_hop_ice_cream, "Stir <i>22 ml (1 1/2 tbsp)</i> of <a href='cornstarch.html'>cornstarch</a> into the <i>120 ml (1/2 cup)</i> of <a href='coconut_milk.html'>coconut milk</a> that was set aside. When dissolved, pour into the pan with the rest of the coconut milk, while whisking slowly.");
...
add_serving(&hop_ice_cream_hop_ice_cream, &sea_salt, "1.25 ml");
add_serving(&hop_ice_cream_hop_ice_cream, &cornstarch, "22 ml");
...
add_instruction(&sunflower_heirloom_carrot_pasta_sunflower_sauce, "Soak <i>120 g (1/4 cup)</i> of <a href='sunflower_seeds.html'>sunflower seeds</a> in water, for <u>1-2h</u>. Rinse and strain, keep aside.");
...
add_serving(&sunflower_heirloom_carrot_pasta_sunflower_sauce, &sunflower_seeds, "120 g");
...
add_serving(&sunflower_heirloom_carrot_pasta_sunflower_sauce, &smoked_paprika, "5 ml");
...
add_instruction(&carrot_kinpira_onigirazu_kinpira_carrot, "Heat <u>15 ml (1 tbsp)</u> of <a href='sesame_oil.html'>sesame oil</a> in a pan at medium heat, add the carrot strips and cook for <u>2-3 minutes</u>. Stir in <i>5 ml (1 tsp)</i>  of <a href='chili_pepper_flakes.html'>chili pepper flakes</a> as well as the sauce prepared in the previous step.");
