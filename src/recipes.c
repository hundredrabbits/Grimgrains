...
add_serving(&raisin_beet_bread_sweet_bread, &whole_cane_sugar, "65g");
...
add_instruction(&black_sesame_syrup_syrup, "Put <i>120 g (1 cup)</i> of <a href='black_sesame_seeds.html'>black sesame seeds</a> in a pan, bring to medium heat and toast them until they start to pop.");
...
add_serving(&black_sesame_syrup_syrup, &black_sesame_seeds, "120 g");
...
add_instruction(&sunflower_heirloom_carrot_pasta_sunflower_sauce, "Soak <i>120 g (1/4 cup)</i> of <a href='sunflower_seeds.html'>sunflower seeds</a> in water, for <u>1-2 hours</u>. Rinse and strain, keep aside.");
...
add_serving(&fresh_pesto_pasta_pesto, &nutritional_yeast, "40 g");
add_serving(&fresh_pesto_pasta_pesto, &salt, "1.25 ml");
add_serving(&fresh_pesto_pasta_pesto, &black_pepper, "1.25 ml");
...
add_instruction(&vegemite_caramel_caramel, "Soak <i>147g (1 cup)</i> chopped of <a href='deglet_noor_dates.html'>deglet noor dates</a> in boiling water for <u>5-10 minutes</u>. Drain.");
...
add_serving(&vegemite_caramel_caramel, &vegemite, "7 ml");
...
add_instruction(&halloween_pumpkin_cookies_cookie_dough, "Stir <i>120 g (1/2 cup)</i> of <a href='all_purpose_flour.html'>all purpose flour</a>, <i>120 g (1/2 cup)</i> of <a href='spelt_flour.html'>spelt flour</a> and <i>7 ml (1 1/2 tsp)</i> of <a href='baking_powder.html'>baking powder</a> together in a bowl.");
...
add_serving(&halloween_pumpkin_cookies_cookie_dough, &baking_powder, "7 ml");
add_serving(&halloween_pumpkin_cookies_cookie_dough, &coconut_sugar, "100 g");
...
add_serving(&halloween_pumpkin_cookies_chocolate, &salt, "1.25 ml");
...
add_instruction(&salted_caramel_carob_chip_cookies_cookies, "In a large bowl, mix <i>165 g (1 1/3 cup)</i> of <a href='einkorn_wheat_flour.html'>einkorn wheat flour</a> with <i>4 ml (3/4 tsp)</i> of <a href='baking_soda.html'>baking soda</a> and <i>1.25 ml (1/4 tsp)</i> of <a href='salt.html'>salt</a>.");
...
add_serving(&salted_caramel_carob_chip_cookies_cookies, &coconut_sugar, "150 g");
add_serving(&salted_caramel_carob_chip_cookies_cookies, &date_caramel, "60 ml");
add_serving(&salted_caramel_carob_chip_cookies_cookies, &baking_soda, "4 ml");
add_serving(&salted_caramel_carob_chip_cookies_cookies, &sea_salt, "1.25 ml");
...
add_serving(&homemade_veganaise_veganaise, &salt, "1.25 ml");
...
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &arrowroot_starch, "22 ml");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &garlic_powder, "1.25 ml");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &onion_powder, "1.25 ml");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &chili_pepper_flakes, "1.25 ml");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &salt, "dash");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &spinach, "20 g");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &lemon_juice, "5 ml");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &apple_cider_vinegar, "2.5 ml");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &soy_milk, "180 ml");
