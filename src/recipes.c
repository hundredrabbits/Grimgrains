...
add_instruction(&chunky_apple_jam_jam, "It's possible to refrigerate and eat the jam right away, but if you want the jar to last longer it is necessary to process the jars in a boiling water canner. To do this, bring a large pot of water to a boil, add the jam jars with enough water to cover them, and those living at 0 - 305 m (0 - 1,000 ft) ought to boil the jars for <u>5-10 minutes</u> (see above notes for altitude adjustments). Turn heat off, but leave jars in pot for an extra <u>5 minutes</u>. Transfer jars to counter-top over a dishtowel, let cool. Once cooled, they're ready to store. Ideally, eat within 12 months.");
