...
add_instruction(&quick_parmesan_mix, "Add <i>105 g (3/4 cup)</i> of unsalted and raw <a href='sunflower_seeds.html'>sunflower seeds</a> with <i>45 g (3 tbsp)</i> of <a href='nutritional_yeast.html'>nutritional yeast</a>, <i>5 g (1/2 tsp)</i> of <a href='garlic_powder.html'>garlic powder</a> and a dash of salt to a food processor (you can also use a handstick blender).");
...
add_serving(&quick_parmesan_mix, &nutritional_yeast, "45 g");
...
add_instruction(&cookie_mix, "In a small bowl, mix <i>15 g (1tbsp)</i> of <a href='flax_seeds'>ground flax seeds</a> with <i>45 ml (45 ml)</i> of <a href='water'>water</a>. This is your flax 'egg', let it thicken for <u>5 minutes</u>.");
add_instruction(&cookie_mix, "Mix <i>125 g (250 ml)</i> of <a href='all_purpose_flour'>all purpose flour</a> with <i>2.5 g (1/4 tsp)</i> of <a href='baking_soda'>baking soda</a> and <i>1.25 g (1/4 tsp)</i> of <a href='salt.html'>salt</a>.");
...
add_serving(&cookie_mix, &vegan_butter, "110 g");
...
add_instruction(&veggie_pate_preparation, "Pulse <i>65 g (1/2 cup)</i> of <a href='rolled_oats'>rolled oats</a> into a fine powder using an immersion blender or mortar and pestle. Add oat powder into the big bowl.");
...
add_instruction(&wakame_bites_cookies, "In a separate bowl, cream <i>75 g (5 tbsp) </i> of <a href='coconut_sugar.html'>coconut sugar</a> with <i>90 ml (6 tbsp)</i> of <a href='canola_oil.html'>canola oil</a>. Stir in the flax seeds and water mix. Put the wet ingredients with the dry ones. ");
...
add_instruction(&shichimi_togarashi_crackers_crackers, "In a bowl, combine <i>120 g (1 cup)</i> <a href='chickpea_flour.html'>chickpea flour</a>, <i>15 g (1 tbsp)</i> <a href='ground_flax_seeds.html'>ground flax seeds</a>, <i>1.25 g (1/4 tsp)</i> of <a href='baking_soda.html'>baking soda</a>, <i>7 ml (1 1/2 tsp)</i> <a href='sesame_oil.html'>sesame oil</a>, <i>1.25 g (1/4 tsp)</i> of <a href='salt.html'>salt</a> and <i>15 g (3 tsp)</i> <a href='shichimi_togarashi.html'>shichimi togarashi</a>.  Stir in <i>60 ml (1/4 cup)</i> of <a href='water.html'>water</a>, mix until well combined and form into a ball. Add extra chickpea flour if the dough is too sticky, 15 g at a time.");
...
add_instruction(&savoury_turmeric_cookies_cookies, "Mix <i>60 g (1/2 cup)</i> of <a href='all_purpose_flour.html'>all purpose flour</a>, <i>60 g (1/2 cup)</i> of <a href='spelt_flour.html'>spelt flour</a>, <i>5 g (1 tsp)</i> of <a href='baking_powder.html'>baking powder</a>, <i>10 g (2 tsp)</i> of <a href='turmeric_powder.html'>turmeric powder</a> and <i>5 g (1 tsp)</i> of ground <a href='dried_orange_peels.html'>dried orange peels</a> in a bowl. Stir well to mix.");
...
add_serving(&savoury_turmeric_cookies_cookies, &baking_powder, "5 g");
add_serving(&savoury_turmeric_cookies_cookies, &ground_turmeric, "10 g");
add_serving(&savoury_turmeric_cookies_cookies, &dried_orange_peel, "5 g");
...
add_instruction(&black_sesame_rice_pancakes_pancakes, "Heat <i>30g (1/4 cup)</i> of <a href='black_sesame_seeds.html'>black sesame seeds</a>, in a non-stick pan at medium heat. Remove once they start to pop. Let cool, then crush into a powder with a mortar and pestle or immersion blender.");
...
add_instruction(&chili_pomegranate_brownies_brownies, "Put <i>45 g (3 tbsp)</i> of <a href='ground_flax_seeds.html'>ground flax seeds</a> in a bowl with <i>135 ml (9 tbsp)</i> of <a href='water.html'>water</a>. Let thicken for <u>5 minutes</u>. Set aside.");
...
add_instruction(&chili_pomegranate_brownies_brownies, "Stir in the flax 'egg', as well as the <i>30 g (2 tbsp)</i> of <a href='chili_pepper_flakes.html'>chili pepper flakes</a> and <i>5 g (1 tsp)</i> of <a href='cayenne_pepper_powder.html'>cayenne pepper powder</a>. Add <i>60 g (1/2 cup)</i> of <a href='all_purpose_flour.html'>all purpose flour</a> and mix well. Mixture should be very thick.");
...
add_serving(&chili_pomegranate_brownies_brownies, &flax_seeds, "45 g");
...
add_serving(&chili_pomegranate_brownies_brownies, &sea_salt, "1.25 g");
add_serving(&chili_pomegranate_brownies_brownies, &all_purpose_flour, "60 g");
add_serving(&chili_pomegranate_brownies_brownies, &chili_pepper_flakes, "30 g");
add_serving(&chili_pomegranate_brownies_brownies, &cayenne_pepper_powder, "5 g");
...
add_serving(&chili_pomegranate_brownies_syrup, &chili_pepper_flakes, "5 g");
add_serving(&chili_pomegranate_brownies_syrup, &cayenne_pepper_powder, "5 g");
...
add_serving(&sunflower_heirloom_carrot_pasta_sunflower_sauce, &nutritional_yeast, "15 g");
...
add_serving(&vegemite_caramel_caramel, &deglet_noor_dates, "147 g");
...
add_instruction(&chickpea_salad_sandwich_chickpea_salad, "Season <a href='black_pepper.html'>black pepper</a> and <a href='shichimi_togarashi.html'>shichimi togarashi</a>, and serve over toasted bread.");
add_serving(&chickpea_salad_sandwich_chickpea_salad, &chickpeas, "250 g, cooked");
add_serving(&chickpea_salad_sandwich_chickpea_salad, &veganaise, "60 g");
add_serving(&chickpea_salad_sandwich_chickpea_salad, &dijon_mustard, "15 g");
...
add_serving(&stovetop_popcorn_toppings, &nutritional_yeast, "45 g");
...
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &nutritional_yeast, "15 g");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &arrowroot_starch, "22 g");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &garlic_powder, "1.25 g");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &onion_powder, "1.25 g");
add_serving(&spinach_faux_cheese_ravioli_cheese_filling, &chili_pepper_flakes, "1.25 g");
...
add_serving(&spinach_faux_cheese_ravioli_ravioli, &salt, "1.25 g");
