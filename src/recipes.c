...
Recipe sunflower_seed_parmesan = create_recipe("sunflower seed parmesan", sauce, "100 g", 20200111, 5);
set_description(&sunflower_seed_parmesan, "A simple recipe, for people (like me) with an allergy to tree nuts. Sunflower seeds come apart well and like cashews or other nuts, create a pleasant texture and taste.<br /><br />I made this parmesan to use over lasagna, it adds a bit of crunch to the top layer. It would also be delicious if used over pasta.<br /><br />");
RecipePart parmesan_mix = create_part("parmesan mix");
add_instruction(&parmesan_mix, "Add <i>105 g (3/4 cup)</i> of <a href='sunflower_seeds.html'>raw sunflower seeds</a> with <i>45 g (3 tbsp)</i> of <a href='nutritional_yeast.html'>nutritional yeast</a>, <i>5 g (1/2 tsp)</i> of <a href='garlic_powder.html'>garlic powder</a> and a dash of salt to a food processor (you can also use a handstick blender).");
add_instruction(&parmesan_mix, "Blend until mixture develops a grainy texture. Store in an airtight container in the refrigerator.");
add_serving(&parmesan_mix, &sunflower_seeds, "105 g");
add_serving(&parmesan_mix, &nutritional_yeast, "45 g");
add_serving(&parmesan_mix, &garlic_powder, "5 g");
add_serving(&parmesan_mix, &salt, "1.25 g");
add_part(&sunflower_seed_parmesan, &parmesan_mix);
