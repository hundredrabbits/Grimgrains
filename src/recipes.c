...
add_instruction(&carrot_kinpira_onigirazu_kinpira_carrot, "Peel and cut <i>2 large</i> <a href='carrot.html'>carrots</a> into thin strips using a julienne peeler (a knife will do, but it will take longer).");
...
add_instruction(&okonomiyaki_okonomiyaki, "Heat a non-stick pan at high heat, and add <i>5 ml (1 tsp)</i> of <a href='sesame_oil.html'>sesame oil</a>. If you throw some water on and it starts to sizzle, the pan is hot and you can add <i>1/4</i> of the batter. Alternatively, you can add 1/2, although this makes two very large portions.");
