...
add_instruction(&soybean_coffee_roast, "Once cooled off, grind the beans(skins and all) in a coffee grinder. <img src='../media/recipes/soybean_coffee_01.jpg'/>");
