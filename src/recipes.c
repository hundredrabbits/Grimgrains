...
add_instruction(&chocolate_peanut_butter_blondies_blondies, "Bake for <u>30-35 minutes</u>. Let cool before cutting. Slice into 24 squares.");
add_serving(&chocolate_peanut_butter_blondies_blondies, &brown_sugar, "180 g");
add_serving(&chocolate_peanut_butter_blondies_blondies, &vegan_butter, "113 g");
add_serving(&chocolate_peanut_butter_blondies_blondies, &peanut_butter, "120 g");
add_serving(&chocolate_peanut_butter_blondies_blondies, &chickpeas, "120 g, cooked");
add_serving(&chocolate_peanut_butter_blondies_blondies, &cocoa_powder, "25 g");
add_serving(&chocolate_peanut_butter_blondies_blondies, &all_purpose_flour, "180 g");
add_serving(&chocolate_peanut_butter_blondies_blondies, &baking_powder, "5 g");
add_serving(&chocolate_peanut_butter_blondies_blondies, &dark_chocolate, "190 g");
add_part(&chocolate_peanut_butter_blondies, &chocolate_peanut_butter_blondies_blondies);
...
Recipe roasted_eggplant_dip = create_recipe("roasted eggplant dip", sauce, "4 servings", 2090206, 50);
...
Recipe *recipes[] = {&roasted_eggplant_dip, &anise_bread_with_sweet_pear_sauce, &arame_soba, &balsamic_banana_ice_cream, &black_sesame_brittle, &black_sesame_rice_pancakes, &black_sesame_syrup, &breaded_veggie_fingers, &brownies, &carrot_kinpira_onigirazu, &cheese, &cheese_and_spinach_ravioli, &chocolate_peanut_butter_blondies, &basic_black_bread, &basic_toothpaste, &beer_bread, &borscht_with_tofu_sour_cream, &breadfruit_gnocchi, &breadfruit_pasta, &buckwheat_tea, &chickpea_salad_sandwich, &chocolate_chip_cookies, &coffee_jelly, &corn_dumplings, &crackers, &dark_gyoza, &fresh_pesto_pasta, &halloween_pumpkin_cookies, &veganaise, &hop_ice_cream, &houjicha_overnight_oatmeal, &lentils_with_roasted_beet_sauce, &mason_jar_bread_pudding, &mushroom_zucchini_pasta, &mustard_from_seed, &no_knead_bread, &okonomiyaki, &pandanus_fruit_bread, &pan_fried_breadfruit, &papaya_bruschetta_topping, &pate_chinois, &persimmon_curry, &potato_gnocchi, &quick_sunflower_seed_parmesan, &raisin_beet_bread, &roasted_carrots_with_beluga_lentils, &roasted_pumpkin_seeds, &scrambled_chickpeas, &spicy_brownies_with_pomegranate_syrup, &sunflower_heirloom_carrot_pasta, &sweet_mock_eel_nigiri, &teriyaki_veggie_patties, &turmeric_cookies, &tzaziki, &salted_caramel_carob_chip_cookies, &seitan, &shichimi_togarashi_crackers, &spicy_stirfry_chickpeas, &spinach_oatmeal_cookies, &spinach_pajeon, &stovetop_popcorn, &sweet_and_sour_lentils, &uzumaki_hummus_bites, &vegemite_caramel, &veggie_pate, &wakame_bites, &wasabi_swirl_chocolate_cookies };