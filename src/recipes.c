...
add_instruction(&vegetable_curry_rice,"Rinse <i>145 g (3/4 cup)</i> of <a href='basmati_rice.html'>white basmati rice</a> for a few minutes to get rid of the starch that makes the rice sticky. Basmati rice requires a water to rice ratio of 2:1. Feel free to use <a href='short_grain_white_rice.html'>short grain white rice</a> instead (ratio of 1:1.25 rice to water).");
