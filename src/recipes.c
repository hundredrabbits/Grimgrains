...
set_description(&chocolate_chip_cookies, "I've been making chocolate chips cookies for a while, but never thought it worthy of a recipe because there are so many online already. In the interest of posting absolute basic recipes though, I felt it deserved to be written down, especially because even if it's easy to make it's possible to make mistakes.<br /><br />There are reasons for the quantities and choice of each ingredient, all interact with each other to give cookies their sweet and soft texture.<br /><br />This basic recipe lends well to a number of variations.<br /><br /><b>Substitutions:</b><br /><br /> <b>FLOUR</b> - If you choose to use spelt flour, a more nutritious alternative, add 1 tsp of baking powder to help it rise.<br /><br /><b>FAT</b> - The fat in cookies is a big part of their structure. I've added vegan butter as is behaves like actual butter, it helps create baked goods that are more tender by shortening gluten strands. When fat coats flour, it slows down the process of gluten formation creating a more tender product <a href='https://bakerbettie.com/function-of-butter-in-baking/#The_Function_of_Butter_in_Baking'>ref</a>. It's possible to make your own vegan butter, check out this <a href='https://www.forkandbeans.com/2015/07/11/vegan-butter-substitute'>recipe by fork and beans</a>.<br /><br /><b>SUGAR</b> - Sugar is important in cookies, it helps with the flavor, color and texture. The oven temperature causes the sugar to react with the proteins, this is what gives baked goods their brown color.<br /><br /><b>ADD-INS</b> - If you have a sensitivity to caffeine use <a href='carob_chips'>carob chips</a> instead of chocolate chips. I used brown sugar as it is a basic ingredient. Opting for coconut sugar or any 'dry' sweetener is perfectly fine, and shouldn't affect the texture.<br /><br /><b>Having problems?</b>'I followed the recipe, but my cookies don't look the same as yours!' The quirkiness of different ovens makes it difficult to give accurate cooking times. Having a thermometer in your oven is the best way to read the temperature accurately. If the cookies don't brown, you will have to leave them in longer. With the oven at my parent's place, I had to bake these cookies for a total of 20 minutes.<br /><br /><b>Help! Cooking spreading too much!</b> If your cookie is spreading too much, you may have added too much sugar. Sugar is hygroscopic, it absorbs liquid but once it bakes it released that and if there's too much, then it keeps spreading. Oven temperature is another factor. The hotter the oven, the more quickly the fat melts before the cookies have time to set. Depending on your oven, you may need to bake cookies longer but at a lower temperatures.<br /><br /><b>Help! Cookie not spreading!</b> One of the most common reasons why cookies don't spread is because there's too much flour in the dough. Try using less, 1/4 to 1/2 cup of flour, and consider increasing the brown sugar by a few tablespoons. This will add slightly more moisture and help the cookies spread. Be sure you're also using room temperature ingredients, especially butter, to promote the best spread and texture.<br /><br />Read more about <a href='https://www.kingarthurflour.com/blog/2016/03/14/cookie-chemistry-2'>cookie chemistry</a>. Recipe inspired from <a href='https://www.kingarthurflour.com/recipes/chocolate-chip-cookies-recipe'>this one</a>. ");
RecipePart cookie_mix = create_part("cookie mix");
add_instruction(&cookie_mix, "Measure <i>1/2 cup</i> of <a href='vegan_butter.html'>vegan butter</a>. It should be slightly cooler than room temp.");
add_instruction(&cookie_mix, "Heat oven to <u>325F</u>.");
add_instruction(&cookie_mix, "In a small bowl, mix <i>1 tbsp</i> of <a href='flax_seeds'>ground flax seeds</a> with <i>3 tbsp</i> of <a href='water'>water</a>. This is your flax 'egg', let it thicken for <u>5 minutes</u>.");
add_instruction(&cookie_mix, "Mix <i>1 cup</i> of <a href='all_purpose_flour'>all purpose flour</a> with <i>1/2 tsp</i> of <a href='baking_soda'>baking soda</a> and <i>1/4 tsp</i> of <a href='salt.html'>salt</a>.");
add_instruction(&cookie_mix, "In a bowl, cream <i>6 tbsp</i> of <a href='granulated_sugar'>granulated sugar</a>, <i>6 tbsp</i> of <a href='brown_sugar'>brown sugar</a> with <i>1/2 cup</i> of <a href='vegan_butter'>vegan butter</a> until well incorporated. Then add <i>2 tbsp</i> of <a href='soy_milk.html'>soy milk</a>, <i>1/2 tsp</i> of <a href='apple_cider_vinegar.html'>apple cider vinegar</a> and the flax egg. Mix again until smooth and creamy.");
...
add_instruction(&cookie_mix, "Bake cookies for <u>10-16 minutes</u>, or until start they start to brown and crisp at the edges. You may need more or less time, depending on your oven. See notes in above description.");
...
add_serving(&cookie_mix, &granulated_sugar, "6 tbsp");
add_serving(&cookie_mix, &brown_sugar, "6 tbsp");
add_serving(&cookie_mix, &vegan_butter, "1/2 cup");
add_serving(&cookie_mix, &soy_milk, "3 tbsp");
add_serving(&cookie_mix, &apple_cider_vinegar, "1/2 tsp");
add_serving(&cookie_mix, &flax_seeds, "1 tbsp, ground");
add_serving(&cookie_mix, &water, "3 tbsp");
add_serving(&cookie_mix, &chocolate_chips, "1 cup");
...
add_serving(&buckwheat_tea_roasting, &buckwheat_groats, "2 tbsp");
add_part(&buckwheat_tea, &buckwheat_tea_roasting);
RecipePart buckwheat_tea_infusion = create_part("infusion");
add_instruction(&buckwheat_tea_infusion, "Add <i>2 tbsp</i> of <a href='buckwheat_groats'>roasted buckwheat groats</a> into the tea strainer of a teapot, and pour <i>3 cups</i> of hot water overtop. Let tea infuse for <u>5-10 minutes</u>.");
...
add_serving(&cheese_cheese, &onion_powder, "1/2 tsp");
add_serving(&cheese_cheese, &apple_cider_vinegar, "1 tsp");
add_serving(&cheese_cheese, &white_miso, "1 tsp");
...
add_instruction(&okonomiyaki_sauce, "In a small bowl, mix <i>4 tbsp</i> of <a href='soy_sauce.html'>soy sauce</a>, <i>4 tbsp</i> of <a href='mirin.html'>mirin</a>, <i>1 tbsp</i> of <a href='granulated_sugar.html'>sugar</a> and <i>1 tbsp</i> of <a href='arrowroot_starch.html'>arrowroot starch</a>. Stir well.");
...
add_serving(&okonomiyaki_sauce, &granulated_sugar, "1 tbsp");
...
add_instruction(&potato_gnocchi_sauce, "Mix <i>6 tbsp</i> of <a href='soy_sauce.html'>soy sauce</a>, <i>3 tbsp</i> of <a href='mirin.html'>mirin</a> and <i>4 tsp</i> of <a href='granulated_sugar.html'>sugar</a> in a bowl.");
add_serving(&potato_gnocchi_sauce, &soy_sauce, "6 tbsp");
add_serving(&potato_gnocchi_sauce, &mirin, "3 tbsp");
add_serving(&potato_gnocchi_sauce, &granulated_sugar, "4 tsp");
...
add_serving(&chili_pomegranate_brownies_syrup, &granulated_sugar, "3/4 cup");
...
add_serving(&anise_bread_with_sweet_pear_sauce_bread, &granulated_sugar, "1/4 cup");
...
add_instruction(&anise_bread_with_sweet_pear_sauce_sauce, "Heat a pan at medium to high heat, add <i>1/4 cup</i> of <a href='canola_oil.html'>canola oil</a>. Once melted, add <i>1 tbsp</i> of <a href='granulated_sugar.html'>sugar</a> and <i>1 tbsp</i> of <a href='maple_syrup.html'>maple syrup</a>.");
...
add_serving(&anise_bread_with_sweet_pear_sauce_sauce, &granulated_sugar, "1 tbsp");
...
add_instruction(&beer_bread_beer_bread, "Coat the bottom of your bread pan with <i>1 tbsp</i> of <a href='canola_oil.html'>vegetable oil</a>, make sure to spread it out evenly, and thinly. Sprinkle <a href='corn_meal.html'>corn meal</a> in your bread pan, or tray, shake the cornmeal around so it covers the entire bottom.");
...
add_serving(&beer_bread_beer_bread, &granulated_sugar, "3 tbsp");
add_serving(&beer_bread_beer_bread, &beer, "1 can");
add_serving(&beer_bread_beer_bread, &cornmeal, "2 tbsp");
add_serving(&beer_bread_beer_bread, &canola_oil, "1 tbsp");
...
add_instruction(&pan_fried_breadfruit_toppings, "Mix <i>4 tbsp</i> <a href='soy_sauce.html'>soy sauce</a> and <i>2 tsp</i> of <a href='granulated_sugar.html'>sugar</a> in a pan, stir, and cook on medium-heat for a few minutes. Add <a href='button_mushrooms.html'>button mushrooms</a>, and stir to coat them with the sauce. Serve over breadfruit wedges.");
...
add_serving(&pan_fried_breadfruit_toppings, &granulated_sugar, "2 tsp");
