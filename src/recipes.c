...
add_instruction(&cookie_mix, "Heat oven to <u>375F</u>.");
...
add_instruction(&cookie_mix, "Bake cookies until they start to brown and crisp at the edges, depending on your oven this may take <u>10-15 minutes</u>. My oven is old and bakes at lower temperatures (and has no thermometer) so I need to bake them for the longer time. See notes in above description.");
