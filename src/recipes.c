...
add_serving(&chunky_apple_jam_jam, &cardamom, "4 pods");
...
set_description(&soy_flour_tofu, "<p>Over the years, we've experimented with various ways of making tofu, our favourite recipe is made from soaking, and then milling, the soy beans. We prefer making our own soy flour with a grain mill, but it's possible to buy pre-ground flour, but make sure it isn't de-fatted.</p><p>Tofu is cheap to make. In Canada, 400g of soy beans costs about 0.35$ in bulk and makes a brick of tofu, the store bought equivalent 400g brick is 3.65$.</p><img src='../media/recipes/soy_flour_tofu_4.jpg'/><p>We choose to make tofu from flour to extract as much milk as we can from the soaked beans.</p><p><b>Nigari</b> is our preferred coagulant, as it imparts less flavor than lemon juice, vinegar or epsom salt.</p><p>We got the idea to make this kind of tofu from <b>The Farm Vegetarian Cookbook</b> by Louise Hagler, and found general tofu-making tips from <b>Cooking With Tofu</b> by Yoshiko Takeuchi.</p><img src='../media/recipes/soy_flour_tofu_1.jpg'/><p>Making tofu on a boat is great, we use the hand-rail to suspend the nylon bag when pressing the milk out of the soy pulp.</p><img src='../media/recipes/soy_flour_tofu_2.jpg'/><p>It is always exciting to see the tofu curds separate from the whey.</p><img src='../media/recipes/soy_flour_tofu_3.jpg'/><p>Making tofu in a bag only is a no-fuss option. You don't need a mold to make tofu.</p>");
