...
Peanuts
  Details : Missing.
Soy beans
  Details : [#EFEFEF milk flour] If you produce your own soy milk, know that there wont be any waste. The pulp can be used to make okara, which you can use to make baked goods.
Beans
  Details : [black green kidney] There are over 130 varieties of green beans.
Edamame
  Details : Missing.
Chickpeas
...
Shiitake
  Details : [#875A2C]
Crimini
  Details : [#875A2C] Mature crimini mushrooms are actually portobello mushrooms
Portobello
  Details : [#875A2C] Portobello are mature 'common mushroom'. They can be used in plantbased recipes as hamburger steaks, you can even use them as buns.
Shimeji
  Details : Missing.
Button Mushrooms
  Details : Missing.
...
Flax seeds
  Details : [#875A2C] Flax is the national flower of Belarus.
Sunflower seeds
  Details : [#875A2C] Missing.
Pumpkin seeds
...
Strawberries
  Details : No description.
Cranberries
  Details : [#94191C dried] Dried cranberries are often coated with a bit of vegetable oil to keep them from sticking to each other, look in natural food stores to find brands that don't do this
Goji
  Details : [#94191C]
Mixed Berries
  Details : Missing.
...
Thyme
  Details : [#006633] Thyme keeps its flavour better when dried than other herbs.
Poppy seeds
...
Soy sauce
  Details : The solids left behind after the fermentation process is used as animal feed
Sriracha
  Details : [#94191C] Sauce is named after the town of Si Racha in thailand where it was first made and served in restaurants.
Mirin
  Details : Mirin is added to grilled fish to help reduce the fishy smell.

~ POWDERS

Baking powder
  Details : [#EFEFEF] Missing.
Bamboo charcoal powder
  Details : [#000000] Bamboo charcoal comes from pieces of bamboo plants, harvested after at least five years, and burned in ovens at temperatures ranging from 800 to 1200 °C. It benefits environmental protection by reducing pollutant residue. It is an environmentally functional material featuring excellent absorption properties. It can be added to foods to give it a black tint, it's very popular in Japan. You can get some through Taketora, a japanese company. (wikipedia description).
Cornstarch
  Details : [#EFEFEF] Missing.
Active dry yeast
  Details : [#FFD800] Missing.
Baking soda
  Details : Since sodium bicarbonate can cause alkalosis, it's sometimes used to treat aspirin overdoses.
Agar agar
  Details : Agar is used to make impression material in dentistry.
Arrowroot starch
  Details : Missing
...
Maple syrup
  Details : [#875A2C] Quebec is the largest producer of maple syrup in the world
Brown rice syrup
  Details : [#875A2C] Brown rice syrup is used to sweeten rice milk.

~ VINEGARS

Rice vinegar
  Details : Substituting rice vinegar for western style vinegar isnt really appropriate, its too acidic.
Balsamic vinegar
  Details : [#6620B3]
Apple cider vinegar
  Details : It is thought that consuming vinegar between meals will help to make you feel full longer.
...
Wine
  Details : [#6620B3] Wine has long been used as an antiseptic to treat wounds, it was even used to treat pain from child birth.
Beer
  Details : No description.
Sake
  Details : No description.
...
Coconut oil
  Details : [#EFEFEF] Coconut oil was used in oil lamps in India before they had electrical lighting.
Canola oil
  Details : Canola oil has many non food uses, it is used in candles, lipsticks, inks etc 
Olive oil
  Details : Extra virgin olive oil has strict requirements, it's checked for all kinds of defects to be made perfect
Sesame oil
  Details : [#875A2C] Sesame oil is sometimes mixed into very hot and spicy food to help neutralize the heat.
Peppermint oil
  Details : Missing
...
Purple potato powder
  Details : [#6620B3]
Baguette
  Details : [#875A2C] A law in the 1920's was put in place to keep bakers from working before 4 am, this didn't give them time to make proper rounded loaves. Making slender baguettes was a simple solution to this problem since they bake more rapidly.
Bread crusts
  Details : [#875A2C] Missing.
Vegan butter
  Details :  No description.
Royal blue colouring
  Details : [#145BAC] Missing.
Violet colouring
  Details : [#6620B3] Missing.
Wholegrain macaroni
  Details : [#875A2C] Missing.
Scoobi do
  Details :  No description.
...
Corn tortillas
  Details : Missing.
Sugar apple
  Details : Sugar apples are covered with scale-like protuberances that you can pry off easily when the fruit is ripe. The skin is soft and sweet and can be eaten with a spoon, once the seeds have been removed. Sugar apples are high energy, and str very rich in minerals. They are a good source of calcium, manganese, phosphorus and vitamins B and C. 
Fleur de sel
  Details : [#efefef]
Vegetable bouillon
  Details : [#875A2C] Dehydrated vegetable bouillon has many names depending on where you live. In Canada and the US it is known as 'bouillon cube', it's known as 'stock cube' in Australia, Ireland, New Zealand, South Africa and in the UK. And as 'dehydrated bouillon' in France.
macaroni
  Details : [wholegrain] Missing.
Tajin
  Details : Missing.
Instant noodles
  Details : Missing.
