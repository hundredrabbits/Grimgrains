...
SEITAN
  ...
  INST
    ...
    BROTH
      - Cut the following ingredients: {#2 cloves#} of {{garlic}}, a {#1/2 large#} {{yellow onion}} and {#1 palm-sized knob#} of {{ginger}}. 
      ...
      - Add the seitan cutlets, reduce heat to low, and cover. Let the seitan simmer for {#1 hour#}. 
    HOW TO SERVE
