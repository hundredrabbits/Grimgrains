...
COFFEE JELLY
  ...
  INST
    BASIC
      ...
      - Lower heat, then add 2g ((~1 1/2 tsp) of {{agar agar powder}}. Stir constantly for {#2 minutes#}.
...
SPINACH PAJEON
  ...
  INST
    Pancake
      - Blend {_1/2 cup_} of {{spinach}} with {_1/2 cup_} of {{water}} until smooth. Set aside.
      - In a bowl, whisk together {_1/2 cup_} of {{spelt flour}}, {_1 tsp_} {{sesame oil}} and the blended spinach.
      - Heat a large pan with {_1 tsp_} of {{sesame oil}} over {_medium heat_}.
...
ROASTED CARROTS WITH BELUGA LENTILS
  ...
  INST
    Carrots 
      ...
      - Wash {_8_} organic {{heirloom carrots}}, do not peel them. Dry the carrots, and then toss them with {_1 tbsp_} of {{olive oil}} and {_1 tsp_} of {{thyme}}.
...
BLACK SESAME BRITTLE
  ...
  INST
    Preparation
      ...
      - Add {_1/4 cup_} of {{black sesame seeds}}. Mix thoroughly.
...
SPINACH OATMEAL COOKIES
  ...
  INST
    Preparation
      ...
      - Puree {_1 handful_} of {{spinach leaves}} with {_1 whole_} {{banana}}.
...
BORSCHT WITH TOFU SOUR CREAM
  ...
  INST
    ...
    Borscht
      - Bring {_4 cups_} of {{vegetable bouillon}} to a boil, add {_2 peeled medium-sized_} {{red beets}}. Boil until softened.
...
DARK YAKI GYOZA
  ...
  INST
    Dough
      ...
      - Dissolve {_1/2 tsp_} of {{salt}} in {_1/2 cup_} of {{just-boiled water}}, and pour into the flour little by little while mixing.
...
RAISIN BEET BREAD
  ...
  INST
    Preparation
      ...
      - Peel and cut {_2 small_} {{red beets}} into cubes, puree in food processor, set aside.
      - Mix {_2 tbsp_} of {{ground flax seeds}} with {_6 tbsp_} of {{water}}, let thicken. In a separate bowl, measure out {_1/4 cup_} of {{coconut oil}}. Add {_1/3 cup_} of {{whole cane sugar}}, gradually, mixing at the same time. In that same bowl, add the {{flax seeds}} and the {{pureed beets}}. This is the sweet part of our bread: the cream.
...
PERSIMMON CURRY
  ...
  INST
    ...
    Sauce
      - Scoop the flesh out of {_2 ripe_} {{hachiya persimmons}}, puree with a hand blender.
      - Sauté {_1 chopped_} {{onion}}, {_2 minced_} {{garlic}} cloves, {_1 tsp_} {{ginger root}} with a bit of {{olive oil}} in a pan over medium heat. Cook until onions become translucent.
      - Add the {_2 diced_} {{carrots}} and the {_handful_} of {{spinach}}. Stir for {#2 minutes#}, then add {_1 tbsp_} of {{curry powder}}. Cook for an additional minute.
